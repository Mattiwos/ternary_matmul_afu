...
#-------------------------------------------------------------------------------
set all_dc_fifo [get_entity_instances matmul_afu_system_fixed_altera_avalon_dc_fifo_191_uyqms3q]
...
set mem_regs [get_registers -nowarn *|matmul_afu_system_fixed_altera_avalon_dc_fifo_191_uyqms3q:*|mem*];
if {![llength [query_collection -report -all $mem_regs]] > 0} {
    set mem_regs [get_registers -nowarn matmul_afu_system_fixed_altera_avalon_dc_fifo_191_uyqms3q:*|mem*];
}

set internal_out_payload_regs [get_registers -nowarn *|matmul_afu_system_fixed_altera_avalon_dc_fifo_191_uyqms3q:*|internal_out_payload*];
