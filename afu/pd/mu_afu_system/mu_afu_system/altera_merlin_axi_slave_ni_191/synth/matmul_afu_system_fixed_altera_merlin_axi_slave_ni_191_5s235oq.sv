...
module matmul_afu_system_fixed_altera_merlin_axi_slave_ni_191_5s235oq
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
  ...
  if (SYNC_RESET == 0) begin : async_fifo
    ...
    matmul_afu_system_fixed_altera_merlin_axi_slave_ni_191_xpmvpbq #(
        .SYMBOLS_PER_BEAT    (1),
    ...
    matmul_afu_system_fixed_altera_merlin_axi_slave_ni_191_7jy4y4y # (
        .IMPL                  ("reg"),
        .SYMBOLS_PER_BEAT      (1),   
        .BITS_PER_SYMBOL       (ST_DATA_W + 1), 
        .FIFO_DEPTH            (WRITE_ACCEPTANCE_CAPABILITY), 
