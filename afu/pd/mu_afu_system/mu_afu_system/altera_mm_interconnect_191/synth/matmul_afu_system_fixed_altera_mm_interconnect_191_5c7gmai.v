// matmul_afu_system_fixed_altera_mm_interconnect_191_5c7gmai.v
...
`timescale 1 ps / 1 ps
module matmul_afu_system_fixed_altera_mm_interconnect_191_5c7gmai (
		input  wire [32:0]  matmul_adu_matmul_ddr4a_bridge_m0_address,                        //                          matmul_adu_matmul_ddr4a_bridge_m0.address
		output wire         matmul_adu_matmul_ddr4a_bridge_m0_waitrequest,                    //                                                           .waitrequest
		input  wire [0:0]   matmul_adu_matmul_ddr4a_bridge_m0_burstcount,                     //                                                           .burstcount
		input  wire [0:0]   matmul_adu_matmul_ddr4a_bridge_m0_byteenable,                     //                                                           .byteenable
		input  wire         matmul_adu_matmul_ddr4a_bridge_m0_read,                           //                                                           .read
		output wire [7:0]   matmul_adu_matmul_ddr4a_bridge_m0_readdata,                       //                                                           .readdata
		output wire         matmul_adu_matmul_ddr4a_bridge_m0_readdatavalid,                  //                                                           .readdatavalid
		input  wire         matmul_adu_matmul_ddr4a_bridge_m0_write,                          //                                                           .write
		input  wire [7:0]   matmul_adu_matmul_ddr4a_bridge_m0_writedata,                      //                                                           .writedata
		input  wire         matmul_adu_matmul_ddr4a_bridge_m0_debugaccess,                    //                                                           .debugaccess
		...
		input  wire         matmul_adu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset_reset, // matmul_adu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset.reset
		input  wire         matmul_afu_dma_clock_out_clk_clk                                  //                               matmul_afu_dma_clock_out_clk.clk
	);

	wire          matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_waitrequest;   // matmul_adu_matmul_ddr4a_bridge_m0_agent:av_waitrequest -> matmul_adu_matmul_ddr4a_bridge_m0_translator:uav_waitrequest
	wire    [7:0] matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_readdata;      // matmul_adu_matmul_ddr4a_bridge_m0_agent:av_readdata -> matmul_adu_matmul_ddr4a_bridge_m0_translator:uav_readdata
	wire          matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_debugaccess;   // matmul_adu_matmul_ddr4a_bridge_m0_translator:uav_debugaccess -> matmul_adu_matmul_ddr4a_bridge_m0_agent:av_debugaccess
	wire   [47:0] matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_address;       // matmul_adu_matmul_ddr4a_bridge_m0_translator:uav_address -> matmul_adu_matmul_ddr4a_bridge_m0_agent:av_address
	wire          matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_read;          // matmul_adu_matmul_ddr4a_bridge_m0_translator:uav_read -> matmul_adu_matmul_ddr4a_bridge_m0_agent:av_read
	wire    [0:0] matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_byteenable;    // matmul_adu_matmul_ddr4a_bridge_m0_translator:uav_byteenable -> matmul_adu_matmul_ddr4a_bridge_m0_agent:av_byteenable
	wire          matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_readdatavalid; // matmul_adu_matmul_ddr4a_bridge_m0_agent:av_readdatavalid -> matmul_adu_matmul_ddr4a_bridge_m0_translator:uav_readdatavalid
	wire          matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_lock;          // matmul_adu_matmul_ddr4a_bridge_m0_translator:uav_lock -> matmul_adu_matmul_ddr4a_bridge_m0_agent:av_lock
	wire          matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_write;         // matmul_adu_matmul_ddr4a_bridge_m0_translator:uav_write -> matmul_adu_matmul_ddr4a_bridge_m0_agent:av_write
	wire    [7:0] matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_writedata;     // matmul_adu_matmul_ddr4a_bridge_m0_translator:uav_writedata -> matmul_adu_matmul_ddr4a_bridge_m0_agent:av_writedata
	wire    [0:0] matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_burstcount;    // matmul_adu_matmul_ddr4a_bridge_m0_translator:uav_burstcount -> matmul_adu_matmul_ddr4a_bridge_m0_agent:av_burstcount
	...
	wire  [673:0] matmul_afu_ddr4_bridge_s0_agent_rf_source_data;                                       // matmul_afu_ddr4_bridge_s0_agent:rf_source_data -> matmul_afu_ddr4_bridge_s0_agent_rsp_fifo:in_data
	...
	wire  [673:0] matmul_afu_ddr4_bridge_s0_agent_rsp_fifo_out_data;                                    // matmul_afu_ddr4_bridge_s0_agent_rsp_fifo:out_data -> matmul_afu_ddr4_bridge_s0_agent:rf_sink_data
	...
	wire          matmul_afu_ddr4_bridge_s0_agent_rdata_fifo_src_valid;                                 // matmul_afu_ddr4_bridge_s0_agent:rdata_fifo_src_valid -> matmul_afu_ddr4_bridge_s0_agent:rdata_fifo_sink_valid
	wire  [513:0] matmul_afu_ddr4_bridge_s0_agent_rdata_fifo_src_data;                                  // matmul_afu_ddr4_bridge_s0_agent:rdata_fifo_src_data -> matmul_afu_ddr4_bridge_s0_agent:rdata_fifo_sink_data
	wire          matmul_afu_ddr4_bridge_s0_agent_rdata_fifo_src_ready;                                 // matmul_afu_ddr4_bridge_s0_agent:rdata_fifo_sink_ready -> matmul_afu_ddr4_bridge_s0_agent:rdata_fifo_src_ready
	wire          cmd_mux_src_valid;                                                                    // cmd_mux:src_valid -> matmul_afu_ddr4_bridge_s0_agent:cp_valid
	wire  [672:0] cmd_mux_src_data;                                                                     // cmd_mux:src_data -> matmul_afu_ddr4_bridge_s0_agent:cp_data
	wire          cmd_mux_src_ready;                                                                    // matmul_afu_ddr4_bridge_s0_agent:cp_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                                  // cmd_mux:src_channel -> matmul_afu_ddr4_bridge_s0_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                                            // cmd_mux:src_startofpacket -> matmul_afu_ddr4_bridge_s0_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                                              // cmd_mux:src_endofpacket -> matmul_afu_ddr4_bridge_s0_agent:cp_endofpacket
	wire          matmul_adu_matmul_ddr4a_bridge_m0_agent_cp_valid;                                     // matmul_adu_matmul_ddr4a_bridge_m0_agent:cp_valid -> router:sink_valid
	wire  [105:0] matmul_adu_matmul_ddr4a_bridge_m0_agent_cp_data;                                      // matmul_adu_matmul_ddr4a_bridge_m0_agent:cp_data -> router:sink_data
	wire          matmul_adu_matmul_ddr4a_bridge_m0_agent_cp_ready;                                     // router:sink_ready -> matmul_adu_matmul_ddr4a_bridge_m0_agent:cp_ready
	wire          matmul_adu_matmul_ddr4a_bridge_m0_agent_cp_startofpacket;                             // matmul_adu_matmul_ddr4a_bridge_m0_agent:cp_startofpacket -> router:sink_startofpacket
	wire          matmul_adu_matmul_ddr4a_bridge_m0_agent_cp_endofpacket;                               // matmul_adu_matmul_ddr4a_bridge_m0_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          matmul_afu_ddr4_bridge_s0_agent_rp_valid;                                             // matmul_afu_ddr4_bridge_s0_agent:rp_valid -> router_002:sink_valid
	wire  [672:0] matmul_afu_ddr4_bridge_s0_agent_rp_data;                                              // matmul_afu_ddr4_bridge_s0_agent:rp_data -> router_002:sink_data
	wire          matmul_afu_ddr4_bridge_s0_agent_rp_ready;                                             // router_002:sink_ready -> matmul_afu_ddr4_bridge_s0_agent:rp_ready
	wire          matmul_afu_ddr4_bridge_s0_agent_rp_startofpacket;                                     // matmul_afu_ddr4_bridge_s0_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          matmul_afu_ddr4_bridge_s0_agent_rp_endofpacket;                                       // matmul_afu_ddr4_bridge_s0_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [672:0] cmd_demux_src0_data;                                                                  // cmd_demux:src0_data -> cmd_mux:sink0_data
	...
	wire  [672:0] rsp_demux_src0_data;                                                                  // rsp_demux:src0_data -> rsp_mux:sink0_data
	...
	wire          rsp_mux_src_valid;                                                                    // rsp_mux:src_valid -> matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter:in_valid
	wire  [672:0] rsp_mux_src_data;                                                                     // rsp_mux:src_data -> matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter:in_data
	wire          rsp_mux_src_ready;                                                                    // matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter:in_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                                  // rsp_mux:src_channel -> matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter:in_channel
	wire          rsp_mux_src_startofpacket;                                                            // rsp_mux:src_startofpacket -> matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_src_endofpacket;                                                              // rsp_mux:src_endofpacket -> matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter:in_endofpacket
	wire          matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_valid;                        // matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter:out_valid -> matmul_adu_matmul_ddr4a_bridge_m0_agent:rp_valid
	wire  [105:0] matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_data;                         // matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter:out_data -> matmul_adu_matmul_ddr4a_bridge_m0_agent:rp_data
	wire          matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_ready;                        // matmul_adu_matmul_ddr4a_bridge_m0_agent:rp_ready -> matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter:out_ready
	wire    [1:0] matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_channel;                      // matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter:out_channel -> matmul_adu_matmul_ddr4a_bridge_m0_agent:rp_channel
	wire          matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_startofpacket;                // matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter:out_startofpacket -> matmul_adu_matmul_ddr4a_bridge_m0_agent:rp_startofpacket
	wire          matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_endofpacket;                  // matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter:out_endofpacket -> matmul_adu_matmul_ddr4a_bridge_m0_agent:rp_endofpacket
	wire          router_src_valid;                                                                     // router:src_valid -> matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter:in_valid
	wire  [105:0] router_src_data;                                                                      // router:src_data -> matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter:in_data
	wire          router_src_ready;                                                                     // matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter:in_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                                                   // router:src_channel -> matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter:in_channel
	wire          router_src_startofpacket;                                                             // router:src_startofpacket -> matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter:in_startofpacket
	wire          router_src_endofpacket;                                                               // router:src_endofpacket -> matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter:in_endofpacket
	wire          matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_valid;                        // matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter:out_valid -> cmd_demux:sink_valid
	wire  [672:0] matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_data;                         // matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter:out_data -> cmd_demux:sink_data
	wire          matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_ready;                        // cmd_demux:sink_ready -> matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter:out_ready
	wire    [1:0] matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_channel;                      // matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter:out_channel -> cmd_demux:sink_channel
	wire          matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_startofpacket;                // matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter:out_startofpacket -> cmd_demux:sink_startofpacket
	wire          matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_endofpacket;                  // matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter:out_endofpacket -> cmd_demux:sink_endofpacket
	...
	) matmul_adu_matmul_ddr4a_bridge_m0_translator (
		.clk                    (matmul_afu_dma_clock_out_clk_clk),                                                     //   input,   width = 1,                       clk.clk
		.reset                  (matmul_adu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset_reset),                     //   input,   width = 1,                     reset.reset
		.uav_address            (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_address),       //  output,  width = 48, avalon_universal_master_0.address
		.uav_burstcount         (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_burstcount),    //  output,   width = 1,                          .burstcount
		.uav_read               (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_read),          //  output,   width = 1,                          .read
		.uav_write              (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_write),         //  output,   width = 1,                          .write
		.uav_waitrequest        (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_waitrequest),   //   input,   width = 1,                          .waitrequest
		.uav_readdatavalid      (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_readdatavalid), //   input,   width = 1,                          .readdatavalid
		.uav_byteenable         (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_byteenable),    //  output,   width = 1,                          .byteenable
		.uav_readdata           (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_readdata),      //   input,   width = 8,                          .readdata
		.uav_writedata          (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_writedata),     //  output,   width = 8,                          .writedata
		.uav_lock               (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_lock),          //  output,   width = 1,                          .lock
		.uav_debugaccess        (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_debugaccess),   //  output,   width = 1,                          .debugaccess
		.av_address             (matmul_adu_matmul_ddr4a_bridge_m0_address),                                            //   input,  width = 33,      avalon_anti_master_0.address
		.av_waitrequest         (matmul_adu_matmul_ddr4a_bridge_m0_waitrequest),                                        //  output,   width = 1,                          .waitrequest
		.av_burstcount          (matmul_adu_matmul_ddr4a_bridge_m0_burstcount),                                         //   input,   width = 1,                          .burstcount
		.av_byteenable          (matmul_adu_matmul_ddr4a_bridge_m0_byteenable),                                         //   input,   width = 1,                          .byteenable
		.av_read                (matmul_adu_matmul_ddr4a_bridge_m0_read),                                               //   input,   width = 1,                          .read
		.av_readdata            (matmul_adu_matmul_ddr4a_bridge_m0_readdata),                                           //  output,   width = 8,                          .readdata
		.av_readdatavalid       (matmul_adu_matmul_ddr4a_bridge_m0_readdatavalid),                                      //  output,   width = 1,                          .readdatavalid
		.av_write               (matmul_adu_matmul_ddr4a_bridge_m0_write),                                              //   input,   width = 1,                          .write
		.av_writedata           (matmul_adu_matmul_ddr4a_bridge_m0_writedata),                                          //   input,   width = 8,                          .writedata
		.av_debugaccess         (matmul_adu_matmul_ddr4a_bridge_m0_debugaccess),                                        //   input,   width = 1,                          .debugaccess
	...
	matmul_afu_system_fixed_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.WUNIQUE_VALUE             (0),
		.SYNC_RESET                (0)
	) matmul_adu_matmul_ddr4a_bridge_m0_agent (
		.clk                   (matmul_afu_dma_clock_out_clk_clk),                                                     //   input,    width = 1,       clk.clk
		.reset                 (matmul_adu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset_reset),                     //   input,    width = 1, clk_reset.reset
		.av_address            (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_address),       //   input,   width = 48,        av.address
		.av_write              (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_write),         //   input,    width = 1,          .write
		.av_read               (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_read),          //   input,    width = 1,          .read
		.av_writedata          (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_writedata),     //   input,    width = 8,          .writedata
		.av_readdata           (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_readdata),      //  output,    width = 8,          .readdata
		.av_waitrequest        (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_waitrequest),   //  output,    width = 1,          .waitrequest
		.av_readdatavalid      (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_readdatavalid), //  output,    width = 1,          .readdatavalid
		.av_byteenable         (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_byteenable),    //   input,    width = 1,          .byteenable
		.av_burstcount         (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_burstcount),    //   input,    width = 1,          .burstcount
		.av_debugaccess        (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_debugaccess),   //   input,    width = 1,          .debugaccess
		.av_lock               (matmul_adu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_lock),          //   input,    width = 1,          .lock
		.cp_valid              (matmul_adu_matmul_ddr4a_bridge_m0_agent_cp_valid),                                     //  output,    width = 1,        cp.valid
		.cp_data               (matmul_adu_matmul_ddr4a_bridge_m0_agent_cp_data),                                      //  output,  width = 106,          .data
		.cp_startofpacket      (matmul_adu_matmul_ddr4a_bridge_m0_agent_cp_startofpacket),                             //  output,    width = 1,          .startofpacket
		.cp_endofpacket        (matmul_adu_matmul_ddr4a_bridge_m0_agent_cp_endofpacket),                               //  output,    width = 1,          .endofpacket
		.cp_ready              (matmul_adu_matmul_ddr4a_bridge_m0_agent_cp_ready),                                     //   input,    width = 1,          .ready
		.rp_valid              (matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_valid),                        //   input,    width = 1,        rp.valid
		.rp_data               (matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_data),                         //   input,  width = 106,          .data
		.rp_channel            (matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_channel),                      //   input,    width = 2,          .channel
		.rp_startofpacket      (matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_startofpacket),                //   input,    width = 1,          .startofpacket
		.rp_endofpacket        (matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_endofpacket),                  //   input,    width = 1,          .endofpacket
		.rp_ready              (matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_ready),                        //  output,    width = 1,          .ready
		.av_response           (),                                                                                     // (terminated),                         
		.av_writeresponsevalid ()                                                                                      // (terminated),                         
	);
	...
	matmul_afu_system_fixed_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (matmul_afu_ddr4_bridge_s0_agent_rp_data),                          //  output,  width = 673,                .data
		...
		.rf_sink_data            (matmul_afu_ddr4_bridge_s0_agent_rsp_fifo_out_data),                //   input,  width = 674,                .data
		...
		.rf_source_data          (matmul_afu_ddr4_bridge_s0_agent_rf_source_data),                   //  output,  width = 674,                .data
		.rdata_fifo_sink_ready   (matmul_afu_ddr4_bridge_s0_agent_rdata_fifo_src_ready),             //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (matmul_afu_ddr4_bridge_s0_agent_rdata_fifo_src_valid),             //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (matmul_afu_ddr4_bridge_s0_agent_rdata_fifo_src_data),              //   input,  width = 514,                .data
	...
	matmul_afu_system_fixed_altera_avalon_sc_fifo_191_e5eqkcq #(
		...
		.clk               (matmul_afu_dma_clock_out_clk_clk),                                 //   input,    width = 1,       clk.clk
		.reset             (matmul_adu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (matmul_afu_ddr4_bridge_s0_agent_rf_source_data),                   //   input,  width = 674,        in.data
		...
		.out_data          (matmul_afu_ddr4_bridge_s0_agent_rsp_fifo_out_data),                //  output,  width = 674,       out.data
	...
	matmul_afu_system_fixed_altera_merlin_router_191_hkqphxi router (
		.sink_ready         (matmul_adu_matmul_ddr4a_bridge_m0_agent_cp_ready),                 //  output,    width = 1,      sink.ready
		.sink_valid         (matmul_adu_matmul_ddr4a_bridge_m0_agent_cp_valid),                 //   input,    width = 1,          .valid
		.sink_data          (matmul_adu_matmul_ddr4a_bridge_m0_agent_cp_data),                  //   input,  width = 106,          .data
		.sink_startofpacket (matmul_adu_matmul_ddr4a_bridge_m0_agent_cp_startofpacket),         //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (matmul_adu_matmul_ddr4a_bridge_m0_agent_cp_endofpacket),           //   input,    width = 1,          .endofpacket
		.clk                (matmul_afu_dma_clock_out_clk_clk),                                 //   input,    width = 1,       clk.clk
		.reset              (matmul_adu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_router_191_bh3mw6y router_001 (
	...
	matmul_afu_system_fixed_altera_merlin_router_191_sto5qgy router_002 (
		...
		.sink_data          (matmul_afu_ddr4_bridge_s0_agent_rp_data),                          //   input,  width = 673,          .data
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_kuuxkea cmd_demux (
		.clk                (matmul_afu_dma_clock_out_clk_clk),                                      //   input,    width = 1,       clk.clk
		.reset              (matmul_adu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset_reset),      //   input,    width = 1, clk_reset.reset
		.sink_ready         (matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_channel),       //   input,    width = 2,          .channel
		.sink_data          (matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_data),          //   input,  width = 673,          .data
		.sink_startofpacket (matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink_valid         (matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_valid),         //   input,    width = 1,          .valid
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_kuuxkea cmd_demux_001 (
		.clk                (matmul_afu_dma_clock_out_clk_clk),                                 //   input,    width = 1,       clk.clk
		.reset              (matmul_adu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_z5iiqoi cmd_mux (
		.clk                 (matmul_afu_dma_clock_out_clk_clk),                                 //   input,    width = 1,       clk.clk
		.reset               (matmul_adu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (cmd_demux_src0_data),                                              //   input,  width = 673,          .data
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_ypgelei rsp_demux (
		.clk                (matmul_afu_dma_clock_out_clk_clk),                                 //   input,    width = 1,       clk.clk
		.reset              (matmul_adu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_r226kcq rsp_mux (
		.clk                 (matmul_afu_dma_clock_out_clk_clk),                                 //   input,    width = 1,       clk.clk
		.reset               (matmul_adu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (rsp_demux_src0_data),                                              //   input,  width = 673,          .data
		.sink0_startofpacket (rsp_demux_src0_startofpacket),                                     //   input,    width = 1,          .startofpacket
		.sink0_endofpacket   (rsp_demux_src0_endofpacket)                                        //   input,    width = 1,          .endofpacket
	);

	matmul_afu_system_fixed_altera_merlin_multiplexer_191_r226kcq rsp_mux_001 (
		.clk                 (matmul_afu_dma_clock_out_clk_clk),                                 //   input,    width = 1,       clk.clk
		.reset               (matmul_adu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_width_adapter_191_croojgy #(
		.IN_PKT_ADDR_H                 (623),
		.IN_PKT_ADDR_L                 (576),
		.IN_PKT_DATA_H                 (511),
		.IN_PKT_DATA_L                 (0),
		...
		.SYNC_RESET                    (0)
	) matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter (
		.clk                  (matmul_afu_dma_clock_out_clk_clk),                                      //   input,    width = 1,       clk.clk
		.reset                (matmul_adu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset_reset),      //   input,    width = 1, clk_reset.reset
		...
		.out_endofpacket      (matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_data),          //  output,  width = 106,          .data
		.out_channel          (matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_channel),       //  output,    width = 2,          .channel
		.out_valid            (matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (matmul_adu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                                                 // (terminated),                         
	);

	matmul_afu_system_fixed_altera_merlin_width_adapter_191_ewxmhlq #(
		.IN_PKT_ADDR_H                 (56),
		.IN_PKT_ADDR_L                 (9),
		.IN_PKT_DATA_H                 (7),
		.IN_PKT_DATA_L                 (0),
		...
		.ENABLE_ADDRESS_ALIGNMENT      (0),
		.SYNC_RESET                    (0)
	) matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter (
		.clk                  (matmul_afu_dma_clock_out_clk_clk),                                      //   input,    width = 1,       clk.clk
		.reset                (matmul_adu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset_reset),      //   input,    width = 1, clk_reset.reset
		...
		.out_endofpacket      (matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_data),          //  output,  width = 673,          .data
		.out_channel          (matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_channel),       //  output,    width = 2,          .channel
		.out_valid            (matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (matmul_adu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                                                 // (terminated),                         
	);
