// matmul_afu_system_fixed_altera_mm_interconnect_191_zhzsq6q.v
...
`timescale 1 ps / 1 ps
module matmul_afu_system_fixed_altera_mm_interconnect_191_zhzsq6q (
		...
		input  wire         matmul_afu_matmul_ddr4a_bridge_m0_translator_reset_reset_bridge_in_reset_reset, // matmul_afu_matmul_ddr4a_bridge_m0_translator_reset_reset_bridge_in_reset.reset
	...
	wire  [105:0] matmul_afu_matmul_ddr4a_bridge_m0_agent_cp_data;                                      // matmul_afu_matmul_ddr4a_bridge_m0_agent:cp_data -> router:sink_data
	...
	wire          rsp_mux_src_valid;                                                                    // rsp_mux:src_valid -> matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter:in_valid
	wire  [672:0] rsp_mux_src_data;                                                                     // rsp_mux:src_data -> matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter:in_data
	wire          rsp_mux_src_ready;                                                                    // matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter:in_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                                  // rsp_mux:src_channel -> matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter:in_channel
	wire          rsp_mux_src_startofpacket;                                                            // rsp_mux:src_startofpacket -> matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_src_endofpacket;                                                              // rsp_mux:src_endofpacket -> matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter:in_endofpacket
	wire          matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_valid;                        // matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter:out_valid -> matmul_afu_matmul_ddr4a_bridge_m0_agent:rp_valid
	wire  [105:0] matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_data;                         // matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter:out_data -> matmul_afu_matmul_ddr4a_bridge_m0_agent:rp_data
	wire          matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_ready;                        // matmul_afu_matmul_ddr4a_bridge_m0_agent:rp_ready -> matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter:out_ready
	wire    [1:0] matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_channel;                      // matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter:out_channel -> matmul_afu_matmul_ddr4a_bridge_m0_agent:rp_channel
	wire          matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_startofpacket;                // matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter:out_startofpacket -> matmul_afu_matmul_ddr4a_bridge_m0_agent:rp_startofpacket
	wire          matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_endofpacket;                  // matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter:out_endofpacket -> matmul_afu_matmul_ddr4a_bridge_m0_agent:rp_endofpacket
	wire          router_src_valid;                                                                     // router:src_valid -> matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter:in_valid
	wire  [105:0] router_src_data;                                                                      // router:src_data -> matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter:in_data
	wire          router_src_ready;                                                                     // matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter:in_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                                                   // router:src_channel -> matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter:in_channel
	wire          router_src_startofpacket;                                                             // router:src_startofpacket -> matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter:in_startofpacket
	wire          router_src_endofpacket;                                                               // router:src_endofpacket -> matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter:in_endofpacket
	wire          matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_valid;                        // matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter:out_valid -> cmd_demux:sink_valid
	wire  [672:0] matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_data;                         // matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter:out_data -> cmd_demux:sink_data
	wire          matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_ready;                        // cmd_demux:sink_ready -> matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter:out_ready
	wire    [1:0] matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_channel;                      // matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter:out_channel -> cmd_demux:sink_channel
	wire          matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_startofpacket;                // matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter:out_startofpacket -> cmd_demux:sink_startofpacket
	wire          matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_endofpacket;                  // matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter:out_endofpacket -> cmd_demux:sink_endofpacket
	...
	matmul_afu_system_fixed_altera_merlin_master_translator_191_g7h47bq #(
		...
		.reset                  (matmul_afu_matmul_ddr4a_bridge_m0_translator_reset_reset_bridge_in_reset_reset),       //   input,   width = 1,                     reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_master_translator_191_g7h47bq #(
		...
		.reset                  (matmul_afu_ddr4_bridge_reset_reset_bridge_in_reset_reset),                     //   input,    width = 1,                     reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.clk                   (matmul_afu_matmul_clock_out_clk_clk),                                                  //   input,    width = 1,       clk.clk
		.reset                 (matmul_afu_matmul_ddr4a_bridge_m0_translator_reset_reset_bridge_in_reset_reset),       //   input,    width = 1, clk_reset.reset
		...
		.cp_data               (matmul_afu_matmul_ddr4a_bridge_m0_agent_cp_data),                                      //  output,  width = 106,          .data
		...
		.rp_valid              (matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_valid),                        //   input,    width = 1,        rp.valid
		.rp_data               (matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_data),                         //   input,  width = 106,          .data
		.rp_channel            (matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_channel),                      //   input,    width = 2,          .channel
		.rp_startofpacket      (matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_startofpacket),                //   input,    width = 1,          .startofpacket
		.rp_endofpacket        (matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_endofpacket),                  //   input,    width = 1,          .endofpacket
		.rp_ready              (matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_ready),                        //  output,    width = 1,          .ready
		.av_response           (),                                                                                     // (terminated),                         
		.av_writeresponsevalid ()                                                                                      // (terminated),                         
	);
	...
	matmul_afu_system_fixed_altera_merlin_router_191_hkqphxi router (
		...
		.sink_data          (matmul_afu_matmul_ddr4a_bridge_m0_agent_cp_data),                                //   input,  width = 106,          .data
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_kuuxkea cmd_demux (
		.clk                (matmul_afu_matmul_clock_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset              (matmul_afu_matmul_ddr4a_bridge_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_ready),                  //  output,    width = 1,      sink.ready
		.sink_channel       (matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_channel),                //   input,    width = 2,          .channel
		.sink_data          (matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_data),                   //   input,  width = 673,          .data
		.sink_startofpacket (matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_startofpacket),          //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_endofpacket),            //   input,    width = 1,          .endofpacket
		.sink_valid         (matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_valid),                  //   input,    width = 1,          .valid
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_pg2skka cmd_mux (
		.clk                 (matmul_afu_dma_clock_out_clk_clk),                         //   input,    width = 1,       clk.clk
		.reset               (matmul_afu_ddr4_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_width_adapter_191_croojgy #(
		...
		.SYNC_RESET                    (0)
	) matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter (
		.clk                  (matmul_afu_matmul_clock_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset                (matmul_afu_matmul_ddr4a_bridge_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.out_endofpacket      (matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_endofpacket),            //  output,    width = 1,       src.endofpacket
		.out_data             (matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_data),                   //  output,  width = 106,          .data
		.out_channel          (matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_channel),                //  output,    width = 2,          .channel
		.out_valid            (matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_valid),                  //  output,    width = 1,          .valid
		.out_ready            (matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_ready),                  //   input,    width = 1,          .ready
		.out_startofpacket    (matmul_afu_matmul_ddr4a_bridge_m0_rsp_width_adapter_src_startofpacket),          //  output,    width = 1,          .startofpacket
	...
	matmul_afu_system_fixed_altera_merlin_width_adapter_191_ewxmhlq #(
		...
		.ENABLE_ADDRESS_ALIGNMENT      (0),
		.SYNC_RESET                    (0)
	) matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter (
		.clk                  (matmul_afu_matmul_clock_out_clk_clk),                                            //   input,    width = 1,       clk.clk
		.reset                (matmul_afu_matmul_ddr4a_bridge_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.out_endofpacket      (matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_endofpacket),            //  output,    width = 1,       src.endofpacket
		.out_data             (matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_data),                   //  output,  width = 673,          .data
		.out_channel          (matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_channel),                //  output,    width = 2,          .channel
		.out_valid            (matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_valid),                  //  output,    width = 1,          .valid
		.out_ready            (matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_ready),                  //   input,    width = 1,          .ready
		.out_startofpacket    (matmul_afu_matmul_ddr4a_bridge_m0_cmd_width_adapter_src_startofpacket),          //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                                                          // (terminated),                         
	);

	matmul_afu_system_fixed_altera_avalon_st_handshake_clock_crosser_191_qbucrri #(
		.DATA_WIDTH          (673),
		.BITS_PER_SYMBOL     (673),
		.USE_PACKETS         (1),
		.USE_CHANNEL         (1),
		...
		.in_reset          (matmul_afu_matmul_ddr4a_bridge_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  in_clk_reset.reset
		.out_clk           (matmul_afu_dma_clock_out_clk_clk),                                               //   input,    width = 1,       out_clk.clk
		.out_reset         (matmul_afu_ddr4_bridge_reset_reset_bridge_in_reset_reset),                       //   input,    width = 1, out_clk_reset.reset
	...
	matmul_afu_system_fixed_altera_avalon_st_handshake_clock_crosser_191_qbucrri #(
		...
		.in_reset          (matmul_afu_ddr4_bridge_reset_reset_bridge_in_reset_reset),                       //   input,    width = 1,  in_clk_reset.reset
		.out_clk           (matmul_afu_matmul_clock_out_clk_clk),                                            //   input,    width = 1,       out_clk.clk
		.out_reset         (matmul_afu_matmul_ddr4a_bridge_m0_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, out_clk_reset.reset
