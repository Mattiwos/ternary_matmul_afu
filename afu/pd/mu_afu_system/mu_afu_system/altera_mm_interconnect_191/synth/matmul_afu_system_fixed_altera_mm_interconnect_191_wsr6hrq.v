// matmul_afu_system_fixed_altera_mm_interconnect_191_wsr6hrq.v
...
`timescale 1 ps / 1 ps
module matmul_afu_system_fixed_altera_mm_interconnect_191_wsr6hrq (
		...
		output wire [6:0]  matmul_afu_pgm_ram_s1_address,                                             //                                               matmul_afu_pgm_ram_s1.address
		output wire        matmul_afu_pgm_ram_s1_write,                                               //                                                                    .write
		input  wire [31:0] matmul_afu_pgm_ram_s1_readdata,                                            //                                                                    .readdata
		output wire [31:0] matmul_afu_pgm_ram_s1_writedata,                                           //                                                                    .writedata
		output wire [3:0]  matmul_afu_pgm_ram_s1_byteenable,                                          //                                                                    .byteenable
	...
	wire   [31:0] matmul_afu_pgm_ram_s1_agent_m0_readdata;                                         // matmul_afu_pgm_ram_s1_translator:uav_readdata -> matmul_afu_pgm_ram_s1_agent:m0_readdata
	...
	wire    [3:0] matmul_afu_pgm_ram_s1_agent_m0_byteenable;                                       // matmul_afu_pgm_ram_s1_agent:m0_byteenable -> matmul_afu_pgm_ram_s1_translator:uav_byteenable
	...
	wire   [31:0] matmul_afu_pgm_ram_s1_agent_m0_writedata;                                        // matmul_afu_pgm_ram_s1_agent:m0_writedata -> matmul_afu_pgm_ram_s1_translator:uav_writedata
	...
	wire    [2:0] matmul_afu_pgm_ram_s1_agent_m0_burstcount;                                       // matmul_afu_pgm_ram_s1_agent:m0_burstcount -> matmul_afu_pgm_ram_s1_translator:uav_burstcount
	...
	wire  [132:0] matmul_afu_pgm_ram_s1_agent_rf_source_data;                                      // matmul_afu_pgm_ram_s1_agent:rf_source_data -> matmul_afu_pgm_ram_s1_agent_rsp_fifo:in_data
	...
	wire  [132:0] matmul_afu_pgm_ram_s1_agent_rsp_fifo_out_data;                                   // matmul_afu_pgm_ram_s1_agent_rsp_fifo:out_data -> matmul_afu_pgm_ram_s1_agent:rf_sink_data
	...
	wire   [33:0] matmul_afu_pgm_ram_s1_agent_rdata_fifo_src_data;                                 // matmul_afu_pgm_ram_s1_agent:rdata_fifo_src_data -> matmul_afu_pgm_ram_s1_agent_rdata_fifo:in_data
	...
	wire   [33:0] matmul_afu_pgm_ram_s1_agent_rdata_fifo_out_data;                                 // matmul_afu_pgm_ram_s1_agent_rdata_fifo:out_data -> matmul_afu_pgm_ram_s1_agent:rdata_fifo_sink_data
	...
	wire  [131:0] matmul_afu_pgm_ram_s1_agent_rp_data;                                             // matmul_afu_pgm_ram_s1_agent:rp_data -> router_007:sink_data
	...
	wire          matmul_afu_pgm_ram_s1_burst_adapter_source0_valid;                               // matmul_afu_pgm_ram_s1_burst_adapter:source0_valid -> matmul_afu_pgm_ram_s1_agent:cp_valid
	wire  [131:0] matmul_afu_pgm_ram_s1_burst_adapter_source0_data;                                // matmul_afu_pgm_ram_s1_burst_adapter:source0_data -> matmul_afu_pgm_ram_s1_agent:cp_data
	wire          matmul_afu_pgm_ram_s1_burst_adapter_source0_ready;                               // matmul_afu_pgm_ram_s1_agent:cp_ready -> matmul_afu_pgm_ram_s1_burst_adapter:source0_ready
	wire    [6:0] matmul_afu_pgm_ram_s1_burst_adapter_source0_channel;                             // matmul_afu_pgm_ram_s1_burst_adapter:source0_channel -> matmul_afu_pgm_ram_s1_agent:cp_channel
	wire          matmul_afu_pgm_ram_s1_burst_adapter_source0_startofpacket;                       // matmul_afu_pgm_ram_s1_burst_adapter:source0_startofpacket -> matmul_afu_pgm_ram_s1_agent:cp_startofpacket
	wire          matmul_afu_pgm_ram_s1_burst_adapter_source0_endofpacket;                         // matmul_afu_pgm_ram_s1_burst_adapter:source0_endofpacket -> matmul_afu_pgm_ram_s1_agent:cp_endofpacket
	...
	wire          router_007_src_valid;                                                            // router_007:src_valid -> matmul_afu_pgm_ram_s1_rsp_width_adapter:in_valid
	wire  [131:0] router_007_src_data;                                                             // router_007:src_data -> matmul_afu_pgm_ram_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                            // matmul_afu_pgm_ram_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire    [6:0] router_007_src_channel;                                                          // router_007:src_channel -> matmul_afu_pgm_ram_s1_rsp_width_adapter:in_channel
	wire          router_007_src_startofpacket;                                                    // router_007:src_startofpacket -> matmul_afu_pgm_ram_s1_rsp_width_adapter:in_startofpacket
	wire          router_007_src_endofpacket;                                                      // router_007:src_endofpacket -> matmul_afu_pgm_ram_s1_rsp_width_adapter:in_endofpacket
	wire          matmul_afu_pgm_ram_s1_rsp_width_adapter_src_valid;                               // matmul_afu_pgm_ram_s1_rsp_width_adapter:out_valid -> rsp_demux_006:sink_valid
	wire  [167:0] matmul_afu_pgm_ram_s1_rsp_width_adapter_src_data;                                // matmul_afu_pgm_ram_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	wire          matmul_afu_pgm_ram_s1_rsp_width_adapter_src_ready;                               // rsp_demux_006:sink_ready -> matmul_afu_pgm_ram_s1_rsp_width_adapter:out_ready
	wire    [6:0] matmul_afu_pgm_ram_s1_rsp_width_adapter_src_channel;                             // matmul_afu_pgm_ram_s1_rsp_width_adapter:out_channel -> rsp_demux_006:sink_channel
	wire          matmul_afu_pgm_ram_s1_rsp_width_adapter_src_startofpacket;                       // matmul_afu_pgm_ram_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_006:sink_startofpacket
	wire          matmul_afu_pgm_ram_s1_rsp_width_adapter_src_endofpacket;                         // matmul_afu_pgm_ram_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_006:sink_endofpacket
	...
	wire          cmd_mux_006_src_valid;                                                           // cmd_mux_006:src_valid -> matmul_afu_pgm_ram_s1_cmd_width_adapter:in_valid
	wire  [167:0] cmd_mux_006_src_data;                                                            // cmd_mux_006:src_data -> matmul_afu_pgm_ram_s1_cmd_width_adapter:in_data
	wire          cmd_mux_006_src_ready;                                                           // matmul_afu_pgm_ram_s1_cmd_width_adapter:in_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                         // cmd_mux_006:src_channel -> matmul_afu_pgm_ram_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_006_src_startofpacket;                                                   // cmd_mux_006:src_startofpacket -> matmul_afu_pgm_ram_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                     // cmd_mux_006:src_endofpacket -> matmul_afu_pgm_ram_s1_cmd_width_adapter:in_endofpacket
	wire          matmul_afu_pgm_ram_s1_cmd_width_adapter_src_valid;                               // matmul_afu_pgm_ram_s1_cmd_width_adapter:out_valid -> matmul_afu_pgm_ram_s1_burst_adapter:sink0_valid
	wire  [131:0] matmul_afu_pgm_ram_s1_cmd_width_adapter_src_data;                                // matmul_afu_pgm_ram_s1_cmd_width_adapter:out_data -> matmul_afu_pgm_ram_s1_burst_adapter:sink0_data
	wire          matmul_afu_pgm_ram_s1_cmd_width_adapter_src_ready;                               // matmul_afu_pgm_ram_s1_burst_adapter:sink0_ready -> matmul_afu_pgm_ram_s1_cmd_width_adapter:out_ready
	wire    [6:0] matmul_afu_pgm_ram_s1_cmd_width_adapter_src_channel;                             // matmul_afu_pgm_ram_s1_cmd_width_adapter:out_channel -> matmul_afu_pgm_ram_s1_burst_adapter:sink0_channel
	wire          matmul_afu_pgm_ram_s1_cmd_width_adapter_src_startofpacket;                       // matmul_afu_pgm_ram_s1_cmd_width_adapter:out_startofpacket -> matmul_afu_pgm_ram_s1_burst_adapter:sink0_startofpacket
	wire          matmul_afu_pgm_ram_s1_cmd_width_adapter_src_endofpacket;                         // matmul_afu_pgm_ram_s1_cmd_width_adapter:out_endofpacket -> matmul_afu_pgm_ram_s1_burst_adapter:sink0_endofpacket
	...
	matmul_afu_system_fixed_altera_merlin_slave_translator_191_x56fcki #(
		...
		.uav_burstcount         (matmul_afu_pgm_ram_s1_agent_m0_burstcount),                 //   input,   width = 3,                         .burstcount
		...
		.uav_byteenable         (matmul_afu_pgm_ram_s1_agent_m0_byteenable),                 //   input,   width = 4,                         .byteenable
		.uav_readdata           (matmul_afu_pgm_ram_s1_agent_m0_readdata),                   //  output,  width = 32,                         .readdata
		.uav_writedata          (matmul_afu_pgm_ram_s1_agent_m0_writedata),                  //   input,  width = 32,                         .writedata
		...
		.av_address             (matmul_afu_pgm_ram_s1_address),                             //  output,   width = 7,      avalon_anti_slave_0.address
		.av_write               (matmul_afu_pgm_ram_s1_write),                               //  output,   width = 1,                         .write
		.av_readdata            (matmul_afu_pgm_ram_s1_readdata),                            //   input,  width = 32,                         .readdata
		.av_writedata           (matmul_afu_pgm_ram_s1_writedata),                           //  output,  width = 32,                         .writedata
		.av_byteenable          (matmul_afu_pgm_ram_s1_byteenable),                          //  output,   width = 4,                         .byteenable
	...
	matmul_afu_system_fixed_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.m0_burstcount           (matmul_afu_pgm_ram_s1_agent_m0_burstcount),                 //  output,    width = 3,                .burstcount
		.m0_byteenable           (matmul_afu_pgm_ram_s1_agent_m0_byteenable),                 //  output,    width = 4,                .byteenable
		...
		.m0_readdata             (matmul_afu_pgm_ram_s1_agent_m0_readdata),                   //   input,   width = 32,                .readdata
		...
		.m0_writedata            (matmul_afu_pgm_ram_s1_agent_m0_writedata),                  //  output,   width = 32,                .writedata
		...
		.rp_data                 (matmul_afu_pgm_ram_s1_agent_rp_data),                       //  output,  width = 132,                .data
		.rp_startofpacket        (matmul_afu_pgm_ram_s1_agent_rp_startofpacket),              //  output,    width = 1,                .startofpacket
		.cp_ready                (matmul_afu_pgm_ram_s1_burst_adapter_source0_ready),         //  output,    width = 1,              cp.ready
		.cp_valid                (matmul_afu_pgm_ram_s1_burst_adapter_source0_valid),         //   input,    width = 1,                .valid
		.cp_data                 (matmul_afu_pgm_ram_s1_burst_adapter_source0_data),          //   input,  width = 132,                .data
		.cp_startofpacket        (matmul_afu_pgm_ram_s1_burst_adapter_source0_startofpacket), //   input,    width = 1,                .startofpacket
		.cp_endofpacket          (matmul_afu_pgm_ram_s1_burst_adapter_source0_endofpacket),   //   input,    width = 1,                .endofpacket
		.cp_channel              (matmul_afu_pgm_ram_s1_burst_adapter_source0_channel),       //   input,    width = 7,                .channel
		...
		.rf_sink_data            (matmul_afu_pgm_ram_s1_agent_rsp_fifo_out_data),             //   input,  width = 133,                .data
		...
		.rf_source_data          (matmul_afu_pgm_ram_s1_agent_rf_source_data),                //  output,  width = 133,                .data
		...
		.rdata_fifo_sink_data    (matmul_afu_pgm_ram_s1_agent_rdata_fifo_out_data),           //   input,   width = 34,                .data
		...
		.rdata_fifo_src_data     (matmul_afu_pgm_ram_s1_agent_rdata_fifo_src_data),           //  output,   width = 34,                .data
		.m0_response             (2'b00),                                                     // (terminated),                               
		.m0_writeresponsevalid   (1'b0),                                                      // (terminated),                               
		.rdata_fifo_sink_error   (1'b0)                                                       // (terminated),                               
	);
	...
	matmul_afu_system_fixed_altera_avalon_sc_fifo_191_e5eqkcq #(
		...
		.clk               (matmul_afu_matmul_clock_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset             (matmul_afu_start_matmul_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (matmul_afu_pgm_ram_s1_agent_rf_source_data),                //   input,  width = 133,        in.data
		...
		.out_data          (matmul_afu_pgm_ram_s1_agent_rsp_fifo_out_data),             //  output,  width = 133,       out.data
	...
	matmul_afu_system_fixed_altera_avalon_sc_fifo_191_e5eqkcq #(
		...
		.clk               (matmul_afu_matmul_clock_out_clk_clk),                       //   input,   width = 1,       clk.clk
		.reset             (matmul_afu_start_matmul_reset_reset_bridge_in_reset_reset), //   input,   width = 1, clk_reset.reset
		.in_data           (matmul_afu_pgm_ram_s1_agent_rdata_fifo_src_data),           //   input,  width = 34,        in.data
		...
		.out_data          (matmul_afu_pgm_ram_s1_agent_rdata_fifo_out_data),           //  output,  width = 34,       out.data
	...
	matmul_afu_system_fixed_altera_merlin_router_191_wqz4rny router (
	...
	matmul_afu_system_fixed_altera_merlin_router_191_a2uwk6i router_007 (
		...
		.sink_data          (matmul_afu_pgm_ram_s1_agent_rp_data),                       //   input,  width = 132,          .data
	...
	matmul_afu_system_fixed_altera_merlin_burst_adapter_191_7phgwai #(
		...
		.ADAPTER_VERSION           ("13.1"),
		.SYNC_RESET                (0)
	) matmul_afu_pgm_ram_s1_burst_adapter (
		.clk                   (matmul_afu_matmul_clock_out_clk_clk),                       //   input,    width = 1,       cr0.clk
		.reset                 (matmul_afu_start_matmul_reset_reset_bridge_in_reset_reset), //   input,    width = 1, cr0_reset.reset
		.sink0_valid           (matmul_afu_pgm_ram_s1_cmd_width_adapter_src_valid),         //   input,    width = 1,     sink0.valid
		.sink0_data            (matmul_afu_pgm_ram_s1_cmd_width_adapter_src_data),          //   input,  width = 132,          .data
		.sink0_channel         (matmul_afu_pgm_ram_s1_cmd_width_adapter_src_channel),       //   input,    width = 7,          .channel
		.sink0_startofpacket   (matmul_afu_pgm_ram_s1_cmd_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink0_endofpacket     (matmul_afu_pgm_ram_s1_cmd_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink0_ready           (matmul_afu_pgm_ram_s1_cmd_width_adapter_src_ready),         //  output,    width = 1,          .ready
		.source0_valid         (matmul_afu_pgm_ram_s1_burst_adapter_source0_valid),         //  output,    width = 1,   source0.valid
		.source0_data          (matmul_afu_pgm_ram_s1_burst_adapter_source0_data),          //  output,  width = 132,          .data
		.source0_channel       (matmul_afu_pgm_ram_s1_burst_adapter_source0_channel),       //  output,    width = 7,          .channel
		.source0_startofpacket (matmul_afu_pgm_ram_s1_burst_adapter_source0_startofpacket), //  output,    width = 1,          .startofpacket
		.source0_endofpacket   (matmul_afu_pgm_ram_s1_burst_adapter_source0_endofpacket),   //  output,    width = 1,          .endofpacket
		.source0_ready         (matmul_afu_pgm_ram_s1_burst_adapter_source0_ready)          //   input,    width = 1,          .ready
	);
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_xqc35eq rsp_demux_006 (
		.clk                (matmul_afu_matmul_clock_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset              (matmul_afu_start_matmul_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (matmul_afu_pgm_ram_s1_rsp_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (matmul_afu_pgm_ram_s1_rsp_width_adapter_src_channel),       //   input,    width = 7,          .channel
		.sink_data          (matmul_afu_pgm_ram_s1_rsp_width_adapter_src_data),          //   input,  width = 168,          .data
		.sink_startofpacket (matmul_afu_pgm_ram_s1_rsp_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (matmul_afu_pgm_ram_s1_rsp_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink_valid         (matmul_afu_pgm_ram_s1_rsp_width_adapter_src_valid),         //   input,    width = 1,          .valid
	...
	matmul_afu_system_fixed_altera_merlin_width_adapter_191_znesz2a #(
		...
		.ENABLE_ADDRESS_ALIGNMENT      (0),
		.SYNC_RESET                    (0)
	) matmul_afu_pgm_ram_s1_rsp_width_adapter (
		.clk                  (matmul_afu_matmul_clock_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset                (matmul_afu_start_matmul_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.in_data              (router_007_src_data),                                       //   input,  width = 132,          .data
		.out_endofpacket      (matmul_afu_pgm_ram_s1_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (matmul_afu_pgm_ram_s1_rsp_width_adapter_src_data),          //  output,  width = 168,          .data
		.out_channel          (matmul_afu_pgm_ram_s1_rsp_width_adapter_src_channel),       //  output,    width = 7,          .channel
		.out_valid            (matmul_afu_pgm_ram_s1_rsp_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (matmul_afu_pgm_ram_s1_rsp_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (matmul_afu_pgm_ram_s1_rsp_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                                     // (terminated),                         
	);
	...
	matmul_afu_system_fixed_altera_merlin_width_adapter_191_34t32ka #(
		...
		.ENABLE_ADDRESS_ALIGNMENT      (0),
		.SYNC_RESET                    (0)
	) matmul_afu_pgm_ram_s1_cmd_width_adapter (
		.clk                  (matmul_afu_matmul_clock_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset                (matmul_afu_start_matmul_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.in_data              (cmd_mux_006_src_data),                                      //   input,  width = 168,          .data
		.out_endofpacket      (matmul_afu_pgm_ram_s1_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (matmul_afu_pgm_ram_s1_cmd_width_adapter_src_data),          //  output,  width = 132,          .data
		.out_channel          (matmul_afu_pgm_ram_s1_cmd_width_adapter_src_channel),       //  output,    width = 7,          .channel
		.out_valid            (matmul_afu_pgm_ram_s1_cmd_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (matmul_afu_pgm_ram_s1_cmd_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (matmul_afu_pgm_ram_s1_cmd_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                                     // (terminated),                         
	);
