// mu_afu_system_altera_mm_interconnect_191_rgedibq.v
...
`timescale 1 ps / 1 ps
module mu_afu_system_altera_mm_interconnect_191_rgedibq (
	...
	wire          mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_waitrequest;   // mu_afu_matrix_unit_avmm_h_ddr_agent:av_waitrequest -> mu_afu_matrix_unit_avmm_h_ddr_translator:uav_waitrequest
	wire    [7:0] mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_readdata;      // mu_afu_matrix_unit_avmm_h_ddr_agent:av_readdata -> mu_afu_matrix_unit_avmm_h_ddr_translator:uav_readdata
	wire          mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_debugaccess;   // mu_afu_matrix_unit_avmm_h_ddr_translator:uav_debugaccess -> mu_afu_matrix_unit_avmm_h_ddr_agent:av_debugaccess
	wire   [47:0] mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_address;       // mu_afu_matrix_unit_avmm_h_ddr_translator:uav_address -> mu_afu_matrix_unit_avmm_h_ddr_agent:av_address
	wire          mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_read;          // mu_afu_matrix_unit_avmm_h_ddr_translator:uav_read -> mu_afu_matrix_unit_avmm_h_ddr_agent:av_read
	wire    [0:0] mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_byteenable;    // mu_afu_matrix_unit_avmm_h_ddr_translator:uav_byteenable -> mu_afu_matrix_unit_avmm_h_ddr_agent:av_byteenable
	wire          mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_readdatavalid; // mu_afu_matrix_unit_avmm_h_ddr_agent:av_readdatavalid -> mu_afu_matrix_unit_avmm_h_ddr_translator:uav_readdatavalid
	wire          mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_lock;          // mu_afu_matrix_unit_avmm_h_ddr_translator:uav_lock -> mu_afu_matrix_unit_avmm_h_ddr_agent:av_lock
	wire          mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_write;         // mu_afu_matrix_unit_avmm_h_ddr_translator:uav_write -> mu_afu_matrix_unit_avmm_h_ddr_agent:av_write
	wire    [7:0] mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_writedata;     // mu_afu_matrix_unit_avmm_h_ddr_translator:uav_writedata -> mu_afu_matrix_unit_avmm_h_ddr_agent:av_writedata
	wire    [0:0] mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_burstcount;    // mu_afu_matrix_unit_avmm_h_ddr_translator:uav_burstcount -> mu_afu_matrix_unit_avmm_h_ddr_agent:av_burstcount
	...
	wire          mu_afu_matrix_unit_avmm_h_ddr_agent_cp_valid;                                     // mu_afu_matrix_unit_avmm_h_ddr_agent:cp_valid -> router:sink_valid
	wire  [105:0] mu_afu_matrix_unit_avmm_h_ddr_agent_cp_data;                                      // mu_afu_matrix_unit_avmm_h_ddr_agent:cp_data -> router:sink_data
	wire          mu_afu_matrix_unit_avmm_h_ddr_agent_cp_ready;                                     // router:sink_ready -> mu_afu_matrix_unit_avmm_h_ddr_agent:cp_ready
	wire          mu_afu_matrix_unit_avmm_h_ddr_agent_cp_startofpacket;                             // mu_afu_matrix_unit_avmm_h_ddr_agent:cp_startofpacket -> router:sink_startofpacket
	wire          mu_afu_matrix_unit_avmm_h_ddr_agent_cp_endofpacket;                               // mu_afu_matrix_unit_avmm_h_ddr_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          rsp_mux_src_valid;                                                                // rsp_mux:src_valid -> mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter:in_valid
	wire  [672:0] rsp_mux_src_data;                                                                 // rsp_mux:src_data -> mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter:in_data
	wire          rsp_mux_src_ready;                                                                // mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter:in_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                              // rsp_mux:src_channel -> mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter:in_channel
	wire          rsp_mux_src_startofpacket;                                                        // rsp_mux:src_startofpacket -> mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_src_endofpacket;                                                          // rsp_mux:src_endofpacket -> mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter:in_endofpacket
	wire          mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_valid;                        // mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter:out_valid -> mu_afu_matrix_unit_avmm_h_ddr_agent:rp_valid
	wire  [105:0] mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_data;                         // mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter:out_data -> mu_afu_matrix_unit_avmm_h_ddr_agent:rp_data
	wire          mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_ready;                        // mu_afu_matrix_unit_avmm_h_ddr_agent:rp_ready -> mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter:out_ready
	wire    [1:0] mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_channel;                      // mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter:out_channel -> mu_afu_matrix_unit_avmm_h_ddr_agent:rp_channel
	wire          mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_startofpacket;                // mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter:out_startofpacket -> mu_afu_matrix_unit_avmm_h_ddr_agent:rp_startofpacket
	wire          mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_endofpacket;                  // mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter:out_endofpacket -> mu_afu_matrix_unit_avmm_h_ddr_agent:rp_endofpacket
	wire          router_src_valid;                                                                 // router:src_valid -> mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter:in_valid
	wire  [105:0] router_src_data;                                                                  // router:src_data -> mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter:in_data
	wire          router_src_ready;                                                                 // mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter:in_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                                               // router:src_channel -> mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter:in_channel
	wire          router_src_startofpacket;                                                         // router:src_startofpacket -> mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter:in_startofpacket
	wire          router_src_endofpacket;                                                           // router:src_endofpacket -> mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter:in_endofpacket
	wire          mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_valid;                        // mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter:out_valid -> cmd_demux:sink_valid
	wire  [672:0] mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_data;                         // mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter:out_data -> cmd_demux:sink_data
	wire          mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_ready;                        // cmd_demux:sink_ready -> mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter:out_ready
	wire    [1:0] mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_channel;                      // mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter:out_channel -> cmd_demux:sink_channel
	wire          mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_startofpacket;                // mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter:out_startofpacket -> cmd_demux:sink_startofpacket
	wire          mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_endofpacket;                  // mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter:out_endofpacket -> cmd_demux:sink_endofpacket
	...
	mu_afu_system_altera_merlin_master_translator_191_g7h47bq #(
		...
		.uav_address            (mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_address),       //  output,  width = 48, avalon_universal_master_0.address
	...
	mu_afu_system_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.WUNIQUE_VALUE             (0),
		.SYNC_RESET                (0)
	) mu_afu_matrix_unit_avmm_h_ddr_agent (
		.clk                   (mu_afu_mu_clock_out_clk_clk),                                                      //   input,    width = 1,       clk.clk
		.reset                 (mu_afu_matrix_unit_reset_n_reset_bridge_in_reset_reset),                           //   input,    width = 1, clk_reset.reset
		.av_address            (mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_address),       //   input,   width = 48,        av.address
		.av_write              (mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_write),         //   input,    width = 1,          .write
		.av_read               (mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_read),          //   input,    width = 1,          .read
		.av_writedata          (mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_writedata),     //   input,    width = 8,          .writedata
		.av_readdata           (mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_readdata),      //  output,    width = 8,          .readdata
		.av_waitrequest        (mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_waitrequest),   //  output,    width = 1,          .waitrequest
		.av_readdatavalid      (mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_readdatavalid), //  output,    width = 1,          .readdatavalid
		.av_byteenable         (mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_byteenable),    //   input,    width = 1,          .byteenable
		.av_burstcount         (mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_burstcount),    //   input,    width = 1,          .burstcount
		.av_debugaccess        (mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_debugaccess),   //   input,    width = 1,          .debugaccess
		.av_lock               (mu_afu_matrix_unit_avmm_h_ddr_translator_avalon_universal_master_0_lock),          //   input,    width = 1,          .lock
		.cp_valid              (mu_afu_matrix_unit_avmm_h_ddr_agent_cp_valid),                                     //  output,    width = 1,        cp.valid
		.cp_data               (mu_afu_matrix_unit_avmm_h_ddr_agent_cp_data),                                      //  output,  width = 106,          .data
		.cp_startofpacket      (mu_afu_matrix_unit_avmm_h_ddr_agent_cp_startofpacket),                             //  output,    width = 1,          .startofpacket
		.cp_endofpacket        (mu_afu_matrix_unit_avmm_h_ddr_agent_cp_endofpacket),                               //  output,    width = 1,          .endofpacket
		.cp_ready              (mu_afu_matrix_unit_avmm_h_ddr_agent_cp_ready),                                     //   input,    width = 1,          .ready
		.rp_valid              (mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_valid),                        //   input,    width = 1,        rp.valid
		.rp_data               (mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_data),                         //   input,  width = 106,          .data
		.rp_channel            (mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_channel),                      //   input,    width = 2,          .channel
		.rp_startofpacket      (mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_startofpacket),                //   input,    width = 1,          .startofpacket
		.rp_endofpacket        (mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_endofpacket),                  //   input,    width = 1,          .endofpacket
		.rp_ready              (mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_ready),                        //  output,    width = 1,          .ready
		.av_response           (),                                                                                 // (terminated),                         
		.av_writeresponsevalid ()                                                                                  // (terminated),                         
	);
	...
	mu_afu_system_altera_merlin_router_191_hkqphxi router (
		.sink_ready         (mu_afu_matrix_unit_avmm_h_ddr_agent_cp_ready),           //  output,    width = 1,      sink.ready
		.sink_valid         (mu_afu_matrix_unit_avmm_h_ddr_agent_cp_valid),           //   input,    width = 1,          .valid
		.sink_data          (mu_afu_matrix_unit_avmm_h_ddr_agent_cp_data),            //   input,  width = 106,          .data
		.sink_startofpacket (mu_afu_matrix_unit_avmm_h_ddr_agent_cp_startofpacket),   //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (mu_afu_matrix_unit_avmm_h_ddr_agent_cp_endofpacket),     //   input,    width = 1,          .endofpacket
		.clk                (mu_afu_mu_clock_out_clk_clk),                            //   input,    width = 1,       clk.clk
		.reset              (mu_afu_matrix_unit_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	mu_afu_system_altera_merlin_demultiplexer_191_kuuxkea cmd_demux (
		.clk                (mu_afu_mu_clock_out_clk_clk),                                       //   input,    width = 1,       clk.clk
		.reset              (mu_afu_matrix_unit_reset_n_reset_bridge_in_reset_reset),            //   input,    width = 1, clk_reset.reset
		.sink_ready         (mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_channel),       //   input,    width = 2,          .channel
		.sink_data          (mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_data),          //   input,  width = 673,          .data
		.sink_startofpacket (mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink_valid         (mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_valid),         //   input,    width = 1,          .valid
	...
	mu_afu_system_altera_merlin_multiplexer_191_z5iiqoi cmd_mux (
		.clk                 (mu_afu_dma_clock_out_clk_clk),                         //   input,    width = 1,       clk.clk
		.reset               (mu_afu_ddr4_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	mu_afu_system_altera_merlin_width_adapter_191_croojgy #(
		...
		.SYNC_RESET                    (0)
	) mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter (
		.clk                  (mu_afu_mu_clock_out_clk_clk),                                       //   input,    width = 1,       clk.clk
		.reset                (mu_afu_matrix_unit_reset_n_reset_bridge_in_reset_reset),            //   input,    width = 1, clk_reset.reset
		...
		.out_endofpacket      (mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_data),          //  output,  width = 106,          .data
		.out_channel          (mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_channel),       //  output,    width = 2,          .channel
		.out_valid            (mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (mu_afu_matrix_unit_avmm_h_ddr_rsp_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
	...
	mu_afu_system_altera_merlin_width_adapter_191_ewxmhlq #(
		...
		.ENABLE_ADDRESS_ALIGNMENT      (0),
		.SYNC_RESET                    (0)
	) mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter (
		.clk                  (mu_afu_mu_clock_out_clk_clk),                                       //   input,    width = 1,       clk.clk
		.reset                (mu_afu_matrix_unit_reset_n_reset_bridge_in_reset_reset),            //   input,    width = 1, clk_reset.reset
		...
		.out_endofpacket      (mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_data),          //  output,  width = 673,          .data
		.out_channel          (mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_channel),       //  output,    width = 2,          .channel
		.out_valid            (mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (mu_afu_matrix_unit_avmm_h_ddr_cmd_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                                             // (terminated),                         
	);
