// matmul_afu_system_fixed_altera_mm_interconnect_191_numsmwa.v
...
`timescale 1 ps / 1 ps
module matmul_afu_system_fixed_altera_mm_interconnect_191_numsmwa (
		...
		input  wire [63:0]  matmul_afu_matmul_ddr4a_bridge_m0_byteenable,                     //                                                           .byteenable
		input  wire         matmul_afu_matmul_ddr4a_bridge_m0_read,                           //                                                           .read
		output wire [511:0] matmul_afu_matmul_ddr4a_bridge_m0_readdata,                       //                                                           .readdata
		...
		input  wire [511:0] matmul_afu_matmul_ddr4a_bridge_m0_writedata,                      //                                                           .writedata
	...
	wire  [511:0] matmul_afu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_readdata;      // matmul_afu_matmul_ddr4a_bridge_m0_agent:av_readdata -> matmul_afu_matmul_ddr4a_bridge_m0_translator:uav_readdata
	...
	wire   [63:0] matmul_afu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_byteenable;    // matmul_afu_matmul_ddr4a_bridge_m0_translator:uav_byteenable -> matmul_afu_matmul_ddr4a_bridge_m0_agent:av_byteenable
	...
	wire  [511:0] matmul_afu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_writedata;     // matmul_afu_matmul_ddr4a_bridge_m0_translator:uav_writedata -> matmul_afu_matmul_ddr4a_bridge_m0_agent:av_writedata
	wire    [6:0] matmul_afu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_burstcount;    // matmul_afu_matmul_ddr4a_bridge_m0_translator:uav_burstcount -> matmul_afu_matmul_ddr4a_bridge_m0_agent:av_burstcount
	...
	wire          cmd_mux_002_src_valid;                                                                // cmd_mux_002:src_valid -> matmul_afu_ddr4_bridge_s0_agent:cp_valid
	wire  [680:0] cmd_mux_002_src_data;                                                                 // cmd_mux_002:src_data -> matmul_afu_ddr4_bridge_s0_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                                // matmul_afu_ddr4_bridge_s0_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [2:0] cmd_mux_002_src_channel;                                                              // cmd_mux_002:src_channel -> matmul_afu_ddr4_bridge_s0_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                                        // cmd_mux_002:src_startofpacket -> matmul_afu_ddr4_bridge_s0_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                          // cmd_mux_002:src_endofpacket -> matmul_afu_ddr4_bridge_s0_agent:cp_endofpacket
	wire          matmul_afu_matmul_ddr4a_bridge_m0_agent_cp_valid;                                     // matmul_afu_matmul_ddr4a_bridge_m0_agent:cp_valid -> router:sink_valid
	wire  [680:0] matmul_afu_matmul_ddr4a_bridge_m0_agent_cp_data;                                      // matmul_afu_matmul_ddr4a_bridge_m0_agent:cp_data -> router:sink_data
	...
	wire  [680:0] router_src_data;                                                                      // router:src_data -> matmul_afu_matmul_ddr4a_bridge_m0_limiter:cmd_sink_data
	...
	wire  [680:0] matmul_afu_matmul_ddr4a_bridge_m0_limiter_rsp_src_data;                               // matmul_afu_matmul_ddr4a_bridge_m0_limiter:rsp_src_data -> matmul_afu_matmul_ddr4a_bridge_m0_agent:rp_data
	...
	wire  [680:0] cmd_demux_001_src0_data;                                                              // cmd_demux_001:src0_data -> cmd_mux:sink1_data
	...
	wire  [680:0] cmd_demux_001_src1_data;                                                              // cmd_demux_001:src1_data -> cmd_mux_001:sink1_data
	...
	wire  [680:0] rsp_demux_src1_data;                                                                  // rsp_demux:src1_data -> rsp_mux_001:sink0_data
	...
	wire  [680:0] rsp_demux_001_src1_data;                                                              // rsp_demux_001:src1_data -> rsp_mux_001:sink1_data
	...
	wire          cmd_mux_src_valid;                                                                    // cmd_mux:src_valid -> domain_0_default_slave_axi_error_if_wr_cmd_width_adapter:in_valid
	wire  [680:0] cmd_mux_src_data;                                                                     // cmd_mux:src_data -> domain_0_default_slave_axi_error_if_wr_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                                    // domain_0_default_slave_axi_error_if_wr_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                                                  // cmd_mux:src_channel -> domain_0_default_slave_axi_error_if_wr_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                                            // cmd_mux:src_startofpacket -> domain_0_default_slave_axi_error_if_wr_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                                              // cmd_mux:src_endofpacket -> domain_0_default_slave_axi_error_if_wr_cmd_width_adapter:in_endofpacket
	wire          domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_valid;                   // domain_0_default_slave_axi_error_if_wr_cmd_width_adapter:out_valid -> domain_0_default_slave_axi_error_if_agent:write_cp_valid
	wire  [248:0] domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_data;                    // domain_0_default_slave_axi_error_if_wr_cmd_width_adapter:out_data -> domain_0_default_slave_axi_error_if_agent:write_cp_data
	wire          domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_ready;                   // domain_0_default_slave_axi_error_if_agent:write_cp_ready -> domain_0_default_slave_axi_error_if_wr_cmd_width_adapter:out_ready
	wire    [2:0] domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_channel;                 // domain_0_default_slave_axi_error_if_wr_cmd_width_adapter:out_channel -> domain_0_default_slave_axi_error_if_agent:write_cp_channel
	wire          domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_startofpacket;           // domain_0_default_slave_axi_error_if_wr_cmd_width_adapter:out_startofpacket -> domain_0_default_slave_axi_error_if_agent:write_cp_startofpacket
	wire          domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_endofpacket;             // domain_0_default_slave_axi_error_if_wr_cmd_width_adapter:out_endofpacket -> domain_0_default_slave_axi_error_if_agent:write_cp_endofpacket
	wire          cmd_mux_001_src_valid;                                                                // cmd_mux_001:src_valid -> domain_0_default_slave_axi_error_if_rd_cmd_width_adapter:in_valid
	wire  [680:0] cmd_mux_001_src_data;                                                                 // cmd_mux_001:src_data -> domain_0_default_slave_axi_error_if_rd_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                                                // domain_0_default_slave_axi_error_if_rd_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                                              // cmd_mux_001:src_channel -> domain_0_default_slave_axi_error_if_rd_cmd_width_adapter:in_channel
	wire          cmd_mux_001_src_startofpacket;                                                        // cmd_mux_001:src_startofpacket -> domain_0_default_slave_axi_error_if_rd_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                          // cmd_mux_001:src_endofpacket -> domain_0_default_slave_axi_error_if_rd_cmd_width_adapter:in_endofpacket
	wire          domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_valid;                   // domain_0_default_slave_axi_error_if_rd_cmd_width_adapter:out_valid -> domain_0_default_slave_axi_error_if_agent:read_cp_valid
	wire  [248:0] domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_data;                    // domain_0_default_slave_axi_error_if_rd_cmd_width_adapter:out_data -> domain_0_default_slave_axi_error_if_agent:read_cp_data
	wire          domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_ready;                   // domain_0_default_slave_axi_error_if_agent:read_cp_ready -> domain_0_default_slave_axi_error_if_rd_cmd_width_adapter:out_ready
	wire    [2:0] domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_channel;                 // domain_0_default_slave_axi_error_if_rd_cmd_width_adapter:out_channel -> domain_0_default_slave_axi_error_if_agent:read_cp_channel
	wire          domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_startofpacket;           // domain_0_default_slave_axi_error_if_rd_cmd_width_adapter:out_startofpacket -> domain_0_default_slave_axi_error_if_agent:read_cp_startofpacket
	wire          domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_endofpacket;             // domain_0_default_slave_axi_error_if_rd_cmd_width_adapter:out_endofpacket -> domain_0_default_slave_axi_error_if_agent:read_cp_endofpacket
	wire          router_002_src_valid;                                                                 // router_002:src_valid -> domain_0_default_slave_axi_error_if_wr_rsp_width_adapter:in_valid
	wire  [248:0] router_002_src_data;                                                                  // router_002:src_data -> domain_0_default_slave_axi_error_if_wr_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                                                 // domain_0_default_slave_axi_error_if_wr_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [2:0] router_002_src_channel;                                                               // router_002:src_channel -> domain_0_default_slave_axi_error_if_wr_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                                         // router_002:src_startofpacket -> domain_0_default_slave_axi_error_if_wr_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                                           // router_002:src_endofpacket -> domain_0_default_slave_axi_error_if_wr_rsp_width_adapter:in_endofpacket
	wire          domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_valid;                   // domain_0_default_slave_axi_error_if_wr_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [680:0] domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_data;                    // domain_0_default_slave_axi_error_if_wr_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_ready;                   // rsp_demux:sink_ready -> domain_0_default_slave_axi_error_if_wr_rsp_width_adapter:out_ready
	wire    [2:0] domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_channel;                 // domain_0_default_slave_axi_error_if_wr_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_startofpacket;           // domain_0_default_slave_axi_error_if_wr_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_endofpacket;             // domain_0_default_slave_axi_error_if_wr_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          router_003_src_valid;                                                                 // router_003:src_valid -> domain_0_default_slave_axi_error_if_rd_rsp_width_adapter:in_valid
	wire  [248:0] router_003_src_data;                                                                  // router_003:src_data -> domain_0_default_slave_axi_error_if_rd_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                                                 // domain_0_default_slave_axi_error_if_rd_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [2:0] router_003_src_channel;                                                               // router_003:src_channel -> domain_0_default_slave_axi_error_if_rd_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                                                         // router_003:src_startofpacket -> domain_0_default_slave_axi_error_if_rd_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                                           // router_003:src_endofpacket -> domain_0_default_slave_axi_error_if_rd_rsp_width_adapter:in_endofpacket
	wire          domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_valid;                   // domain_0_default_slave_axi_error_if_rd_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [680:0] domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_data;                    // domain_0_default_slave_axi_error_if_rd_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_ready;                   // rsp_demux_001:sink_ready -> domain_0_default_slave_axi_error_if_rd_rsp_width_adapter:out_ready
	wire    [2:0] domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_channel;                 // domain_0_default_slave_axi_error_if_rd_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire          domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_startofpacket;           // domain_0_default_slave_axi_error_if_rd_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire          domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_endofpacket;             // domain_0_default_slave_axi_error_if_rd_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire          cmd_demux_src0_valid;                                                                 // cmd_demux:src0_valid -> async_fifo:in_valid
	wire  [680:0] cmd_demux_src0_data;                                                                  // cmd_demux:src0_data -> async_fifo:in_data
	wire          cmd_demux_src0_ready;                                                                 // async_fifo:in_ready -> cmd_demux:src0_ready
	wire    [2:0] cmd_demux_src0_channel;                                                               // cmd_demux:src0_channel -> async_fifo:in_channel
	...
	wire  [680:0] async_fifo_out_data;                                                                  // async_fifo:out_data -> cmd_mux:sink0_data
	...
	wire  [680:0] cmd_demux_src1_data;                                                                  // cmd_demux:src1_data -> async_fifo_001:in_data
	wire          cmd_demux_src1_ready;                                                                 // async_fifo_001:in_ready -> cmd_demux:src1_ready
	wire    [2:0] cmd_demux_src1_channel;                                                               // cmd_demux:src1_channel -> async_fifo_001:in_channel
	...
	wire  [680:0] async_fifo_001_out_data;                                                              // async_fifo_001:out_data -> cmd_mux_001:sink0_data
	...
	wire  [680:0] cmd_demux_src2_data;                                                                  // cmd_demux:src2_data -> async_fifo_002:in_data
	wire          cmd_demux_src2_ready;                                                                 // async_fifo_002:in_ready -> cmd_demux:src2_ready
	wire    [2:0] cmd_demux_src2_channel;                                                               // cmd_demux:src2_channel -> async_fifo_002:in_channel
	...
	wire          rsp_demux_src0_valid;                                                                 // rsp_demux:src0_valid -> async_fifo_003:in_valid
	wire  [680:0] rsp_demux_src0_data;                                                                  // rsp_demux:src0_data -> async_fifo_003:in_data
	wire          rsp_demux_src0_ready;                                                                 // async_fifo_003:in_ready -> rsp_demux:src0_ready
	wire    [2:0] rsp_demux_src0_channel;                                                               // rsp_demux:src0_channel -> async_fifo_003:in_channel
	wire          rsp_demux_src0_startofpacket;                                                         // rsp_demux:src0_startofpacket -> async_fifo_003:in_startofpacket
	wire          rsp_demux_src0_endofpacket;                                                           // rsp_demux:src0_endofpacket -> async_fifo_003:in_endofpacket
	wire          async_fifo_003_out_valid;                                                             // async_fifo_003:out_valid -> rsp_mux:sink0_valid
	wire  [680:0] async_fifo_003_out_data;                                                              // async_fifo_003:out_data -> rsp_mux:sink0_data
	...
	wire          rsp_demux_001_src0_valid;                                                             // rsp_demux_001:src0_valid -> async_fifo_004:in_valid
	wire  [680:0] rsp_demux_001_src0_data;                                                              // rsp_demux_001:src0_data -> async_fifo_004:in_data
	wire          rsp_demux_001_src0_ready;                                                             // async_fifo_004:in_ready -> rsp_demux_001:src0_ready
	wire    [2:0] rsp_demux_001_src0_channel;                                                           // rsp_demux_001:src0_channel -> async_fifo_004:in_channel
	wire          rsp_demux_001_src0_startofpacket;                                                     // rsp_demux_001:src0_startofpacket -> async_fifo_004:in_startofpacket
	wire          rsp_demux_001_src0_endofpacket;                                                       // rsp_demux_001:src0_endofpacket -> async_fifo_004:in_endofpacket
	wire          async_fifo_004_out_valid;                                                             // async_fifo_004:out_valid -> rsp_mux:sink1_valid
	wire  [680:0] async_fifo_004_out_data;                                                              // async_fifo_004:out_data -> rsp_mux:sink1_data
	...
	wire          rsp_demux_002_src0_valid;                                                             // rsp_demux_002:src0_valid -> async_fifo_005:in_valid
	wire  [680:0] rsp_demux_002_src0_data;                                                              // rsp_demux_002:src0_data -> async_fifo_005:in_data
	wire          rsp_demux_002_src0_ready;                                                             // async_fifo_005:in_ready -> rsp_demux_002:src0_ready
	wire    [2:0] rsp_demux_002_src0_channel;                                                           // rsp_demux_002:src0_channel -> async_fifo_005:in_channel
	wire          rsp_demux_002_src0_startofpacket;                                                     // rsp_demux_002:src0_startofpacket -> async_fifo_005:in_startofpacket
	wire          rsp_demux_002_src0_endofpacket;                                                       // rsp_demux_002:src0_endofpacket -> async_fifo_005:in_endofpacket
	wire          async_fifo_005_out_valid;                                                             // async_fifo_005:out_valid -> rsp_mux:sink2_valid
	wire  [680:0] async_fifo_005_out_data;                                                              // async_fifo_005:out_data -> rsp_mux:sink2_data
	...
	wire  [680:0] matmul_afu_matmul_ddr4a_bridge_m0_limiter_cmd_src_data;                               // matmul_afu_matmul_ddr4a_bridge_m0_limiter:cmd_src_data -> limiter_pipeline:in_data
	...
	wire  [680:0] limiter_pipeline_source0_data;                                                        // limiter_pipeline:out_data -> cmd_demux:sink_data
	...
	wire  [680:0] rsp_mux_src_data;                                                                     // rsp_mux:src_data -> limiter_pipeline_001:in_data
	...
	wire  [680:0] limiter_pipeline_001_source0_data;                                                    // limiter_pipeline_001:out_data -> matmul_afu_matmul_ddr4a_bridge_m0_limiter:rsp_sink_data
	...
	matmul_afu_system_fixed_altera_merlin_master_translator_191_g7h47bq #(
		...
		.uav_burstcount         (matmul_afu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_burstcount),    //  output,    width = 7,                          .burstcount
		...
		.uav_byteenable         (matmul_afu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_byteenable),    //  output,   width = 64,                          .byteenable
		.uav_readdata           (matmul_afu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_readdata),      //   input,  width = 512,                          .readdata
		.uav_writedata          (matmul_afu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_writedata),     //  output,  width = 512,                          .writedata
		...
		.av_byteenable          (matmul_afu_matmul_ddr4a_bridge_m0_byteenable),                                         //   input,   width = 64,                          .byteenable
		.av_read                (matmul_afu_matmul_ddr4a_bridge_m0_read),                                               //   input,    width = 1,                          .read
		.av_readdata            (matmul_afu_matmul_ddr4a_bridge_m0_readdata),                                           //  output,  width = 512,                          .readdata
		...
		.av_writedata           (matmul_afu_matmul_ddr4a_bridge_m0_writedata),                                          //   input,  width = 512,                          .writedata
	...
	matmul_afu_system_fixed_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.av_writedata          (matmul_afu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_writedata),     //   input,  width = 512,          .writedata
		.av_readdata           (matmul_afu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_readdata),      //  output,  width = 512,          .readdata
		...
		.av_byteenable         (matmul_afu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_byteenable),    //   input,   width = 64,          .byteenable
		.av_burstcount         (matmul_afu_matmul_ddr4a_bridge_m0_translator_avalon_universal_master_0_burstcount),    //   input,    width = 7,          .burstcount
		...
		.cp_data               (matmul_afu_matmul_ddr4a_bridge_m0_agent_cp_data),                                      //  output,  width = 681,          .data
		...
		.rp_data               (matmul_afu_matmul_ddr4a_bridge_m0_limiter_rsp_src_data),                               //   input,  width = 681,          .data
	...
	matmul_afu_system_fixed_altera_merlin_axi_slave_ni_191_3snfkpq #(
		...
		.read_cp_valid          (domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_valid),         //   input,    width = 1,           read_cp.valid
		.read_cp_ready          (domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_ready),         //  output,    width = 1,                  .ready
		.read_cp_data           (domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_data),          //   input,  width = 249,                  .data
		.read_cp_channel        (domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_channel),       //   input,    width = 3,                  .channel
		.read_cp_startofpacket  (domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_startofpacket), //   input,    width = 1,                  .startofpacket
		.read_cp_endofpacket    (domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_endofpacket),   //   input,    width = 1,                  .endofpacket
		.write_cp_ready         (domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_ready),         //  output,    width = 1,          write_cp.ready
		.write_cp_valid         (domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_valid),         //   input,    width = 1,                  .valid
		.write_cp_data          (domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_data),          //   input,  width = 249,                  .data
		.write_cp_channel       (domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_channel),       //   input,    width = 3,                  .channel
		.write_cp_startofpacket (domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_startofpacket), //   input,    width = 1,                  .startofpacket
		.write_cp_endofpacket   (domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_endofpacket),   //   input,    width = 1,                  .endofpacket
	...
	matmul_afu_system_fixed_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.cp_data                 (cmd_mux_002_src_data),                                       //   input,  width = 681,                .data
	...
	matmul_afu_system_fixed_altera_merlin_router_191_cnthalq router (
		...
		.sink_data          (matmul_afu_matmul_ddr4a_bridge_m0_agent_cp_data),                  //   input,  width = 681,          .data
		...
		.src_data           (router_src_data),                                                  //  output,  width = 681,          .data
	...
	matmul_afu_system_fixed_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_sink_data          (router_src_data),                                                  //   input,  width = 681,          .data
		...
		.cmd_src_data           (matmul_afu_matmul_ddr4a_bridge_m0_limiter_cmd_src_data),           //  output,  width = 681,          .data
		...
		.rsp_sink_data          (limiter_pipeline_001_source0_data),                                //   input,  width = 681,          .data
		...
		.rsp_src_data           (matmul_afu_matmul_ddr4a_bridge_m0_limiter_rsp_src_data),           //  output,  width = 681,          .data
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_smzpsni cmd_demux (
		.clk                (matmul_afu_matmul_clock_out_clk_clk),                              //   input,    width = 1,       clk.clk
		.reset              (matmul_afu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (limiter_pipeline_source0_data),                                    //   input,  width = 681,          .data
		...
		.src2_data          (cmd_demux_src2_data),                                              //  output,  width = 681,          .data
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_6ogsk3a cmd_mux (
		.clk                 (matmul_afu_dma_clock_out_clk_clk),             //   input,    width = 1,       clk.clk
		.reset               (msgdma_bbb_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_src_ready),                            //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_src_valid),                            //  output,    width = 1,          .valid
		.src_data            (cmd_mux_src_data),                             //  output,  width = 681,          .data
		...
		.sink0_data          (async_fifo_out_data),                          //   input,  width = 681,          .data
		...
		.sink1_data          (cmd_demux_001_src0_data),                      //   input,  width = 681,          .data
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_6ogsk3a cmd_mux_001 (
		.clk                 (matmul_afu_dma_clock_out_clk_clk),             //   input,    width = 1,       clk.clk
		.reset               (msgdma_bbb_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_001_src_ready),                        //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_001_src_valid),                        //  output,    width = 1,          .valid
		.src_data            (cmd_mux_001_src_data),                         //  output,  width = 681,          .data
		...
		.sink0_data          (async_fifo_001_out_data),                      //   input,  width = 681,          .data
		...
		.sink1_data          (cmd_demux_001_src1_data),                      //   input,  width = 681,          .data
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_wfqkyiq cmd_mux_002 (
		.clk                 (matmul_afu_dma_clock_out_clk_clk),             //   input,    width = 1,       clk.clk
		.reset               (msgdma_bbb_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_j2dlhvi rsp_demux (
		.clk                (matmul_afu_dma_clock_out_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset              (msgdma_bbb_reset_reset_bridge_in_reset_reset),                               //   input,    width = 1, clk_reset.reset
		.sink_ready         (domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_channel),       //   input,    width = 3,          .channel
		.sink_data          (domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_data),          //   input,  width = 681,          .data
		.sink_startofpacket (domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink_valid         (domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_valid),         //   input,    width = 1,          .valid
		.src0_ready         (rsp_demux_src0_ready),                                                       //   input,    width = 1,      src0.ready
		.src0_valid         (rsp_demux_src0_valid),                                                       //  output,    width = 1,          .valid
		.src0_data          (rsp_demux_src0_data),                                                        //  output,  width = 681,          .data
		...
		.src1_data          (rsp_demux_src1_data),                                                        //  output,  width = 681,          .data
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_j2dlhvi rsp_demux_001 (
		.clk                (matmul_afu_dma_clock_out_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset              (msgdma_bbb_reset_reset_bridge_in_reset_reset),                               //   input,    width = 1, clk_reset.reset
		.sink_ready         (domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_channel),       //   input,    width = 3,          .channel
		.sink_data          (domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_data),          //   input,  width = 681,          .data
		.sink_startofpacket (domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink_valid         (domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_valid),         //   input,    width = 1,          .valid
		.src0_ready         (rsp_demux_001_src0_ready),                                                   //   input,    width = 1,      src0.ready
		.src0_valid         (rsp_demux_001_src0_valid),                                                   //  output,    width = 1,          .valid
		.src0_data          (rsp_demux_001_src0_data),                                                    //  output,  width = 681,          .data
		...
		.src1_data          (rsp_demux_001_src1_data),                                                    //  output,  width = 681,          .data
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_blovysy rsp_mux (
		.clk                 (matmul_afu_matmul_clock_out_clk_clk),                              //   input,    width = 1,       clk.clk
		.reset               (matmul_afu_matmul_ddr4a_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_src_ready),                                                //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_src_valid),                                                //  output,    width = 1,          .valid
		.src_data            (rsp_mux_src_data),                                                 //  output,  width = 681,          .data
		...
		.sink0_data          (async_fifo_003_out_data),                                          //   input,  width = 681,          .data
		...
		.sink1_data          (async_fifo_004_out_data),                                          //   input,  width = 681,          .data
		...
		.sink2_data          (async_fifo_005_out_data),                                          //   input,  width = 681,          .data
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_blovysy rsp_mux_001 (
		...
		.sink0_data          (rsp_demux_src1_data),                          //   input,  width = 681,          .data
		...
		.sink1_data          (rsp_demux_001_src1_data),                      //   input,  width = 681,          .data
	...
	matmul_afu_system_fixed_altera_merlin_width_adapter_191_t7oqcpa #(
		...
		.SYNC_RESET                    (1)
	) domain_0_default_slave_axi_error_if_wr_cmd_width_adapter (
		.clk                  (matmul_afu_dma_clock_out_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset                (msgdma_bbb_reset_reset_bridge_in_reset_reset),                               //   input,    width = 1, clk_reset.reset
		...
		.in_data              (cmd_mux_src_data),                                                           //   input,  width = 681,          .data
		.out_endofpacket      (domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_data),          //  output,  width = 249,          .data
		.out_channel          (domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_channel),       //  output,    width = 3,          .channel
		.out_valid            (domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (domain_0_default_slave_axi_error_if_wr_cmd_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
	...
	matmul_afu_system_fixed_altera_merlin_width_adapter_191_t7oqcpa #(
		...
		.ENABLE_ADDRESS_ALIGNMENT      (0),
		.SYNC_RESET                    (1)
	) domain_0_default_slave_axi_error_if_rd_cmd_width_adapter (
		.clk                  (matmul_afu_dma_clock_out_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset                (msgdma_bbb_reset_reset_bridge_in_reset_reset),                               //   input,    width = 1, clk_reset.reset
		...
		.in_data              (cmd_mux_001_src_data),                                                       //   input,  width = 681,          .data
		.out_endofpacket      (domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_data),          //  output,  width = 249,          .data
		.out_channel          (domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_channel),       //  output,    width = 3,          .channel
		.out_valid            (domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (domain_0_default_slave_axi_error_if_rd_cmd_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                                                      // (terminated),                         
	);
	...
	matmul_afu_system_fixed_altera_merlin_width_adapter_191_2urvgga #(
		...
		.ENABLE_ADDRESS_ALIGNMENT      (0),
		.SYNC_RESET                    (1)
	) domain_0_default_slave_axi_error_if_wr_rsp_width_adapter (
		.clk                  (matmul_afu_dma_clock_out_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset                (msgdma_bbb_reset_reset_bridge_in_reset_reset),                               //   input,    width = 1, clk_reset.reset
		...
		.in_data              (router_002_src_data),                                                        //   input,  width = 249,          .data
		.out_endofpacket      (domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_data),          //  output,  width = 681,          .data
		.out_channel          (domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_channel),       //  output,    width = 3,          .channel
		.out_valid            (domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (domain_0_default_slave_axi_error_if_wr_rsp_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                                                      // (terminated),                         
	);
	...
	matmul_afu_system_fixed_altera_merlin_width_adapter_191_2urvgga #(
		...
		.ENABLE_ADDRESS_ALIGNMENT      (0),
		.SYNC_RESET                    (1)
	) domain_0_default_slave_axi_error_if_rd_rsp_width_adapter (
		.clk                  (matmul_afu_dma_clock_out_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset                (msgdma_bbb_reset_reset_bridge_in_reset_reset),                               //   input,    width = 1, clk_reset.reset
		...
		.in_data              (router_003_src_data),                                                        //   input,  width = 249,          .data
		.out_endofpacket      (domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_data),          //  output,  width = 681,          .data
		.out_channel          (domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_channel),       //  output,    width = 3,          .channel
		.out_valid            (domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (domain_0_default_slave_axi_error_if_rd_rsp_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                                                      // (terminated),                         
	);
	...
	matmul_afu_system_fixed_altera_avalon_dc_fifo_191_uyqms3q #(
		...
		.in_data            (cmd_demux_src0_data),                                       //   input,  width = 681,            in.data
		...
		.out_data           (async_fifo_out_data),                                       //  output,  width = 681,           out.data
	...
	matmul_afu_system_fixed_altera_avalon_dc_fifo_191_uyqms3q #(
		...
		.out_clk            (matmul_afu_dma_clock_out_clk_clk),                          //   input,    width = 1,       out_clk.clk
		.out_reset_n        (~matmul_afu_ddr4_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, out_clk_reset.reset_n
		.in_data            (cmd_demux_src1_data),                                       //   input,  width = 681,            in.data
		...
		.out_data           (async_fifo_001_out_data),                                   //  output,  width = 681,           out.data
	...
	matmul_afu_system_fixed_altera_avalon_dc_fifo_191_uyqms3q #(
		...
		.out_clk            (matmul_afu_dma_clock_out_clk_clk),                          //   input,    width = 1,       out_clk.clk
		.out_reset_n        (~matmul_afu_ddr4_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, out_clk_reset.reset_n
		.in_data            (cmd_demux_src2_data),                                       //   input,  width = 681,            in.data
	...
	matmul_afu_system_fixed_altera_avalon_dc_fifo_191_uyqms3q #(
		...
		.in_data            (rsp_demux_src0_data),                                       //   input,  width = 681,            in.data
		...
		.out_data           (async_fifo_003_out_data),                                   //  output,  width = 681,           out.data
	...
	matmul_afu_system_fixed_altera_avalon_dc_fifo_191_uyqms3q #(
		...
		.out_clk            (matmul_afu_matmul_clock_out_clk_clk),                       //   input,    width = 1,       out_clk.clk
		.out_reset_n        (~async_fifo_in_clk_reset_reset_bridge_in_reset_reset),      //   input,    width = 1, out_clk_reset.reset_n
		.in_data            (rsp_demux_001_src0_data),                                   //   input,  width = 681,            in.data
		...
		.out_data           (async_fifo_004_out_data),                                   //  output,  width = 681,           out.data
	...
	matmul_afu_system_fixed_altera_avalon_dc_fifo_191_uyqms3q #(
		...
		.out_clk            (matmul_afu_matmul_clock_out_clk_clk),                       //   input,    width = 1,       out_clk.clk
		.out_reset_n        (~async_fifo_in_clk_reset_reset_bridge_in_reset_reset),      //   input,    width = 1, out_clk_reset.reset_n
		.in_data            (rsp_demux_002_src0_data),                                   //   input,  width = 681,            in.data
		...
		.out_data           (async_fifo_005_out_data),                                   //  output,  width = 681,           out.data
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_data           (matmul_afu_matmul_ddr4a_bridge_m0_limiter_cmd_src_data),          //   input,  width = 681,          .data
		...
		.out_data          (limiter_pipeline_source0_data),                                   //  output,  width = 681,          .data
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_data           (rsp_mux_src_data),                                    //   input,  width = 681,          .data
		...
		.out_data          (limiter_pipeline_001_source0_data),                   //  output,  width = 681,          .data
