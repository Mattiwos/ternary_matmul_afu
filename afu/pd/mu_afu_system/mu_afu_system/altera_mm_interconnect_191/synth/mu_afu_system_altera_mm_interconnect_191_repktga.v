// mu_afu_system_altera_mm_interconnect_191_repktga.v
...
`timescale 1 ps / 1 ps
module mu_afu_system_altera_mm_interconnect_191_repktga (
		...
		output wire [7:0]  matrix_unit_0_avmm_a_csr_address,                                          //                                            matrix_unit_0_avmm_a_csr.address
		output wire        matrix_unit_0_avmm_a_csr_write,                                            //                                                                    .write
		input  wire [31:0] matrix_unit_0_avmm_a_csr_readdata,                                         //                                                                    .readdata
		output wire [31:0] matrix_unit_0_avmm_a_csr_writedata,                                        //                                                                    .writedata
		output wire        matrix_unit_0_avmm_a_csr_chipselect,                                       //                                                                    .chipselect
		...
		output wire [5:0]  matmul_afu_pgm_ram_s1_address,                                             //                                               matmul_afu_pgm_ram_s1.address
	...
	wire    [5:0] cmd_mux_src_channel;                                                             // cmd_mux:src_channel -> matmul_afu_id_afu_afu_cfg_slave_agent:cp_channel
	...
	wire    [5:0] cmd_mux_001_src_channel;                                                         // cmd_mux_001:src_channel -> matmul_afu_id_matmul_afu_cfg_slave_agent:cp_channel
	...
	wire    [5:0] cmd_mux_002_src_channel;                                                         // cmd_mux_002:src_channel -> matmul_afu_id_dma_afu_cfg_slave_agent:cp_channel
	...
	wire   [31:0] matrix_unit_0_avmm_a_csr_agent_m0_readdata;                                      // matrix_unit_0_avmm_a_csr_translator:uav_readdata -> matrix_unit_0_avmm_a_csr_agent:m0_readdata
	wire          matrix_unit_0_avmm_a_csr_agent_m0_waitrequest;                                   // matrix_unit_0_avmm_a_csr_translator:uav_waitrequest -> matrix_unit_0_avmm_a_csr_agent:m0_waitrequest
	wire          matrix_unit_0_avmm_a_csr_agent_m0_debugaccess;                                   // matrix_unit_0_avmm_a_csr_agent:m0_debugaccess -> matrix_unit_0_avmm_a_csr_translator:uav_debugaccess
	wire   [47:0] matrix_unit_0_avmm_a_csr_agent_m0_address;                                       // matrix_unit_0_avmm_a_csr_agent:m0_address -> matrix_unit_0_avmm_a_csr_translator:uav_address
	wire    [3:0] matrix_unit_0_avmm_a_csr_agent_m0_byteenable;                                    // matrix_unit_0_avmm_a_csr_agent:m0_byteenable -> matrix_unit_0_avmm_a_csr_translator:uav_byteenable
	wire          matrix_unit_0_avmm_a_csr_agent_m0_read;                                          // matrix_unit_0_avmm_a_csr_agent:m0_read -> matrix_unit_0_avmm_a_csr_translator:uav_read
	wire          matrix_unit_0_avmm_a_csr_agent_m0_readdatavalid;                                 // matrix_unit_0_avmm_a_csr_translator:uav_readdatavalid -> matrix_unit_0_avmm_a_csr_agent:m0_readdatavalid
	wire          matrix_unit_0_avmm_a_csr_agent_m0_lock;                                          // matrix_unit_0_avmm_a_csr_agent:m0_lock -> matrix_unit_0_avmm_a_csr_translator:uav_lock
	wire   [31:0] matrix_unit_0_avmm_a_csr_agent_m0_writedata;                                     // matrix_unit_0_avmm_a_csr_agent:m0_writedata -> matrix_unit_0_avmm_a_csr_translator:uav_writedata
	wire          matrix_unit_0_avmm_a_csr_agent_m0_write;                                         // matrix_unit_0_avmm_a_csr_agent:m0_write -> matrix_unit_0_avmm_a_csr_translator:uav_write
	wire    [2:0] matrix_unit_0_avmm_a_csr_agent_m0_burstcount;                                    // matrix_unit_0_avmm_a_csr_agent:m0_burstcount -> matrix_unit_0_avmm_a_csr_translator:uav_burstcount
	wire          matrix_unit_0_avmm_a_csr_agent_rf_source_valid;                                  // matrix_unit_0_avmm_a_csr_agent:rf_source_valid -> matrix_unit_0_avmm_a_csr_agent_rsp_fifo:in_valid
	wire  [132:0] matrix_unit_0_avmm_a_csr_agent_rf_source_data;                                   // matrix_unit_0_avmm_a_csr_agent:rf_source_data -> matrix_unit_0_avmm_a_csr_agent_rsp_fifo:in_data
	wire          matrix_unit_0_avmm_a_csr_agent_rf_source_ready;                                  // matrix_unit_0_avmm_a_csr_agent_rsp_fifo:in_ready -> matrix_unit_0_avmm_a_csr_agent:rf_source_ready
	wire          matrix_unit_0_avmm_a_csr_agent_rf_source_startofpacket;                          // matrix_unit_0_avmm_a_csr_agent:rf_source_startofpacket -> matrix_unit_0_avmm_a_csr_agent_rsp_fifo:in_startofpacket
	wire          matrix_unit_0_avmm_a_csr_agent_rf_source_endofpacket;                            // matrix_unit_0_avmm_a_csr_agent:rf_source_endofpacket -> matrix_unit_0_avmm_a_csr_agent_rsp_fifo:in_endofpacket
	wire          matrix_unit_0_avmm_a_csr_agent_rsp_fifo_out_valid;                               // matrix_unit_0_avmm_a_csr_agent_rsp_fifo:out_valid -> matrix_unit_0_avmm_a_csr_agent:rf_sink_valid
	wire  [132:0] matrix_unit_0_avmm_a_csr_agent_rsp_fifo_out_data;                                // matrix_unit_0_avmm_a_csr_agent_rsp_fifo:out_data -> matrix_unit_0_avmm_a_csr_agent:rf_sink_data
	wire          matrix_unit_0_avmm_a_csr_agent_rsp_fifo_out_ready;                               // matrix_unit_0_avmm_a_csr_agent:rf_sink_ready -> matrix_unit_0_avmm_a_csr_agent_rsp_fifo:out_ready
	wire          matrix_unit_0_avmm_a_csr_agent_rsp_fifo_out_startofpacket;                       // matrix_unit_0_avmm_a_csr_agent_rsp_fifo:out_startofpacket -> matrix_unit_0_avmm_a_csr_agent:rf_sink_startofpacket
	wire          matrix_unit_0_avmm_a_csr_agent_rsp_fifo_out_endofpacket;                         // matrix_unit_0_avmm_a_csr_agent_rsp_fifo:out_endofpacket -> matrix_unit_0_avmm_a_csr_agent:rf_sink_endofpacket
	wire          matrix_unit_0_avmm_a_csr_agent_rdata_fifo_src_valid;                             // matrix_unit_0_avmm_a_csr_agent:rdata_fifo_src_valid -> matrix_unit_0_avmm_a_csr_agent_rdata_fifo:in_valid
	wire   [33:0] matrix_unit_0_avmm_a_csr_agent_rdata_fifo_src_data;                              // matrix_unit_0_avmm_a_csr_agent:rdata_fifo_src_data -> matrix_unit_0_avmm_a_csr_agent_rdata_fifo:in_data
	wire          matrix_unit_0_avmm_a_csr_agent_rdata_fifo_src_ready;                             // matrix_unit_0_avmm_a_csr_agent_rdata_fifo:in_ready -> matrix_unit_0_avmm_a_csr_agent:rdata_fifo_src_ready
	wire          matrix_unit_0_avmm_a_csr_agent_rdata_fifo_out_valid;                             // matrix_unit_0_avmm_a_csr_agent_rdata_fifo:out_valid -> matrix_unit_0_avmm_a_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] matrix_unit_0_avmm_a_csr_agent_rdata_fifo_out_data;                              // matrix_unit_0_avmm_a_csr_agent_rdata_fifo:out_data -> matrix_unit_0_avmm_a_csr_agent:rdata_fifo_sink_data
	wire          matrix_unit_0_avmm_a_csr_agent_rdata_fifo_out_ready;                             // matrix_unit_0_avmm_a_csr_agent:rdata_fifo_sink_ready -> matrix_unit_0_avmm_a_csr_agent_rdata_fifo:out_ready
	...
	wire          cmd_mux_005_src_valid;                                                           // cmd_mux_005:src_valid -> matmul_afu_pgm_ram_s1_agent:cp_valid
	wire  [167:0] cmd_mux_005_src_data;                                                            // cmd_mux_005:src_data -> matmul_afu_pgm_ram_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                           // matmul_afu_pgm_ram_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                         // cmd_mux_005:src_channel -> matmul_afu_pgm_ram_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                                   // cmd_mux_005:src_startofpacket -> matmul_afu_pgm_ram_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                     // cmd_mux_005:src_endofpacket -> matmul_afu_pgm_ram_s1_agent:cp_endofpacket
	...
	wire          matrix_unit_0_avmm_a_csr_agent_rp_valid;                                         // matrix_unit_0_avmm_a_csr_agent:rp_valid -> router_004:sink_valid
	wire  [131:0] matrix_unit_0_avmm_a_csr_agent_rp_data;                                          // matrix_unit_0_avmm_a_csr_agent:rp_data -> router_004:sink_data
	wire          matrix_unit_0_avmm_a_csr_agent_rp_ready;                                         // router_004:sink_ready -> matrix_unit_0_avmm_a_csr_agent:rp_ready
	wire          matrix_unit_0_avmm_a_csr_agent_rp_startofpacket;                                 // matrix_unit_0_avmm_a_csr_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          matrix_unit_0_avmm_a_csr_agent_rp_endofpacket;                                   // matrix_unit_0_avmm_a_csr_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          matmul_afu_pgm_ram_s1_agent_rp_valid;                                            // matmul_afu_pgm_ram_s1_agent:rp_valid -> router_006:sink_valid
	wire  [167:0] matmul_afu_pgm_ram_s1_agent_rp_data;                                             // matmul_afu_pgm_ram_s1_agent:rp_data -> router_006:sink_data
	wire          matmul_afu_pgm_ram_s1_agent_rp_ready;                                            // router_006:sink_ready -> matmul_afu_pgm_ram_s1_agent:rp_ready
	wire          matmul_afu_pgm_ram_s1_agent_rp_startofpacket;                                    // matmul_afu_pgm_ram_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          matmul_afu_pgm_ram_s1_agent_rp_endofpacket;                                      // matmul_afu_pgm_ram_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire    [5:0] router_src_channel;                                                              // router:src_channel -> matmul_afu_csr_bridge_master_limiter:cmd_sink_channel
	...
	wire    [5:0] matmul_afu_csr_bridge_master_limiter_cmd_src_channel;                            // matmul_afu_csr_bridge_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire    [5:0] rsp_mux_src_channel;                                                             // rsp_mux:src_channel -> matmul_afu_csr_bridge_master_limiter:rsp_sink_channel
	...
	wire    [5:0] matmul_afu_csr_bridge_master_limiter_rsp_src_channel;                            // matmul_afu_csr_bridge_master_limiter:rsp_src_channel -> matmul_afu_csr_bridge_master_agent:rp_channel
	...
	wire          matrix_unit_0_avmm_a_csr_burst_adapter_source0_valid;                            // matrix_unit_0_avmm_a_csr_burst_adapter:source0_valid -> matrix_unit_0_avmm_a_csr_agent:cp_valid
	wire  [131:0] matrix_unit_0_avmm_a_csr_burst_adapter_source0_data;                             // matrix_unit_0_avmm_a_csr_burst_adapter:source0_data -> matrix_unit_0_avmm_a_csr_agent:cp_data
	wire          matrix_unit_0_avmm_a_csr_burst_adapter_source0_ready;                            // matrix_unit_0_avmm_a_csr_agent:cp_ready -> matrix_unit_0_avmm_a_csr_burst_adapter:source0_ready
	wire    [5:0] matrix_unit_0_avmm_a_csr_burst_adapter_source0_channel;                          // matrix_unit_0_avmm_a_csr_burst_adapter:source0_channel -> matrix_unit_0_avmm_a_csr_agent:cp_channel
	wire          matrix_unit_0_avmm_a_csr_burst_adapter_source0_startofpacket;                    // matrix_unit_0_avmm_a_csr_burst_adapter:source0_startofpacket -> matrix_unit_0_avmm_a_csr_agent:cp_startofpacket
	wire          matrix_unit_0_avmm_a_csr_burst_adapter_source0_endofpacket;                      // matrix_unit_0_avmm_a_csr_burst_adapter:source0_endofpacket -> matrix_unit_0_avmm_a_csr_agent:cp_endofpacket
	...
	wire          router_004_src_valid;                                                            // router_004:src_valid -> matrix_unit_0_avmm_a_csr_rsp_width_adapter:in_valid
	wire  [131:0] router_004_src_data;                                                             // router_004:src_data -> matrix_unit_0_avmm_a_csr_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                            // matrix_unit_0_avmm_a_csr_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [5:0] router_004_src_channel;                                                          // router_004:src_channel -> matrix_unit_0_avmm_a_csr_rsp_width_adapter:in_channel
	wire          router_004_src_startofpacket;                                                    // router_004:src_startofpacket -> matrix_unit_0_avmm_a_csr_rsp_width_adapter:in_startofpacket
	wire          router_004_src_endofpacket;                                                      // router_004:src_endofpacket -> matrix_unit_0_avmm_a_csr_rsp_width_adapter:in_endofpacket
	wire          matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_valid;                            // matrix_unit_0_avmm_a_csr_rsp_width_adapter:out_valid -> rsp_demux_003:sink_valid
	wire  [167:0] matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_data;                             // matrix_unit_0_avmm_a_csr_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	wire          matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_ready;                            // rsp_demux_003:sink_ready -> matrix_unit_0_avmm_a_csr_rsp_width_adapter:out_ready
	wire    [5:0] matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_channel;                          // matrix_unit_0_avmm_a_csr_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	wire          matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_startofpacket;                    // matrix_unit_0_avmm_a_csr_rsp_width_adapter:out_startofpacket -> rsp_demux_003:sink_startofpacket
	wire          matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_endofpacket;                      // matrix_unit_0_avmm_a_csr_rsp_width_adapter:out_endofpacket -> rsp_demux_003:sink_endofpacket
	wire          cmd_mux_003_src_valid;                                                           // cmd_mux_003:src_valid -> matrix_unit_0_avmm_a_csr_cmd_width_adapter:in_valid
	wire  [167:0] cmd_mux_003_src_data;                                                            // cmd_mux_003:src_data -> matrix_unit_0_avmm_a_csr_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                                           // matrix_unit_0_avmm_a_csr_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                                         // cmd_mux_003:src_channel -> matrix_unit_0_avmm_a_csr_cmd_width_adapter:in_channel
	wire          cmd_mux_003_src_startofpacket;                                                   // cmd_mux_003:src_startofpacket -> matrix_unit_0_avmm_a_csr_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                     // cmd_mux_003:src_endofpacket -> matrix_unit_0_avmm_a_csr_cmd_width_adapter:in_endofpacket
	wire          matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_valid;                            // matrix_unit_0_avmm_a_csr_cmd_width_adapter:out_valid -> matrix_unit_0_avmm_a_csr_burst_adapter:sink0_valid
	wire  [131:0] matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_data;                             // matrix_unit_0_avmm_a_csr_cmd_width_adapter:out_data -> matrix_unit_0_avmm_a_csr_burst_adapter:sink0_data
	wire          matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_ready;                            // matrix_unit_0_avmm_a_csr_burst_adapter:sink0_ready -> matrix_unit_0_avmm_a_csr_cmd_width_adapter:out_ready
	wire    [5:0] matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_channel;                          // matrix_unit_0_avmm_a_csr_cmd_width_adapter:out_channel -> matrix_unit_0_avmm_a_csr_burst_adapter:sink0_channel
	wire          matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_startofpacket;                    // matrix_unit_0_avmm_a_csr_cmd_width_adapter:out_startofpacket -> matrix_unit_0_avmm_a_csr_burst_adapter:sink0_startofpacket
	wire          matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_endofpacket;                      // matrix_unit_0_avmm_a_csr_cmd_width_adapter:out_endofpacket -> matrix_unit_0_avmm_a_csr_burst_adapter:sink0_endofpacket
	...
	wire    [5:0] matmul_afu_csr_bridge_master_limiter_cmd_valid_data;                             // matmul_afu_csr_bridge_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	mu_afu_system_altera_merlin_slave_translator_191_x56fcki #(
		...
		.WAITREQUEST_ALLOWANCE          (0),
		.SYNC_RESET                     (0)
	) matrix_unit_0_avmm_a_csr_translator (
		...
		.uav_address            (matrix_unit_0_avmm_a_csr_agent_m0_address),         //   input,  width = 48, avalon_universal_slave_0.address
		.uav_burstcount         (matrix_unit_0_avmm_a_csr_agent_m0_burstcount),      //   input,   width = 3,                         .burstcount
		.uav_read               (matrix_unit_0_avmm_a_csr_agent_m0_read),            //   input,   width = 1,                         .read
		.uav_write              (matrix_unit_0_avmm_a_csr_agent_m0_write),           //   input,   width = 1,                         .write
		.uav_waitrequest        (matrix_unit_0_avmm_a_csr_agent_m0_waitrequest),     //  output,   width = 1,                         .waitrequest
		.uav_readdatavalid      (matrix_unit_0_avmm_a_csr_agent_m0_readdatavalid),   //  output,   width = 1,                         .readdatavalid
		.uav_byteenable         (matrix_unit_0_avmm_a_csr_agent_m0_byteenable),      //   input,   width = 4,                         .byteenable
		.uav_readdata           (matrix_unit_0_avmm_a_csr_agent_m0_readdata),        //  output,  width = 32,                         .readdata
		.uav_writedata          (matrix_unit_0_avmm_a_csr_agent_m0_writedata),       //   input,  width = 32,                         .writedata
		.uav_lock               (matrix_unit_0_avmm_a_csr_agent_m0_lock),            //   input,   width = 1,                         .lock
		.uav_debugaccess        (matrix_unit_0_avmm_a_csr_agent_m0_debugaccess),     //   input,   width = 1,                         .debugaccess
		.av_address             (matrix_unit_0_avmm_a_csr_address),                  //  output,   width = 8,      avalon_anti_slave_0.address
		.av_write               (matrix_unit_0_avmm_a_csr_write),                    //  output,   width = 1,                         .write
		.av_readdata            (matrix_unit_0_avmm_a_csr_readdata),                 //   input,  width = 32,                         .readdata
		.av_writedata           (matrix_unit_0_avmm_a_csr_writedata),                //  output,  width = 32,                         .writedata
		.av_chipselect          (matrix_unit_0_avmm_a_csr_chipselect),               //  output,   width = 1,                         .chipselect
		.av_read                (),                                                  // (terminated),                                       
		.av_begintransfer       (),                                                  // (terminated),                                       
		.av_beginbursttransfer  (),                                                  // (terminated),                                       
		.av_burstcount          (),                                                  // (terminated),                                       
	...
	mu_afu_system_altera_merlin_slave_translator_191_x56fcki #(
		...
		.av_address             (matmul_afu_pgm_ram_s1_address),                     //  output,   width = 6,      avalon_anti_slave_0.address
	...
	mu_afu_system_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.rp_channel            (matmul_afu_csr_bridge_master_limiter_rsp_src_channel),                            //   input,    width = 6,          .channel
	...
	mu_afu_system_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.ECC_ENABLE                (0),
		.SYNC_RESET                (0)
	) matrix_unit_0_avmm_a_csr_agent (
		.clk                     (matmul_afu_matmul_clock_out_clk_clk),                          //   input,    width = 1,             clk.clk
		.reset                   (matrix_unit_0_reset_n_reset_bridge_in_reset_reset),            //   input,    width = 1,       clk_reset.reset
		.m0_address              (matrix_unit_0_avmm_a_csr_agent_m0_address),                    //  output,   width = 48,              m0.address
		.m0_burstcount           (matrix_unit_0_avmm_a_csr_agent_m0_burstcount),                 //  output,    width = 3,                .burstcount
		.m0_byteenable           (matrix_unit_0_avmm_a_csr_agent_m0_byteenable),                 //  output,    width = 4,                .byteenable
		.m0_debugaccess          (matrix_unit_0_avmm_a_csr_agent_m0_debugaccess),                //  output,    width = 1,                .debugaccess
		.m0_lock                 (matrix_unit_0_avmm_a_csr_agent_m0_lock),                       //  output,    width = 1,                .lock
		.m0_readdata             (matrix_unit_0_avmm_a_csr_agent_m0_readdata),                   //   input,   width = 32,                .readdata
		.m0_readdatavalid        (matrix_unit_0_avmm_a_csr_agent_m0_readdatavalid),              //   input,    width = 1,                .readdatavalid
		.m0_read                 (matrix_unit_0_avmm_a_csr_agent_m0_read),                       //  output,    width = 1,                .read
		.m0_waitrequest          (matrix_unit_0_avmm_a_csr_agent_m0_waitrequest),                //   input,    width = 1,                .waitrequest
		.m0_writedata            (matrix_unit_0_avmm_a_csr_agent_m0_writedata),                  //  output,   width = 32,                .writedata
		.m0_write                (matrix_unit_0_avmm_a_csr_agent_m0_write),                      //  output,    width = 1,                .write
		.rp_endofpacket          (matrix_unit_0_avmm_a_csr_agent_rp_endofpacket),                //  output,    width = 1,              rp.endofpacket
		.rp_ready                (matrix_unit_0_avmm_a_csr_agent_rp_ready),                      //   input,    width = 1,                .ready
		.rp_valid                (matrix_unit_0_avmm_a_csr_agent_rp_valid),                      //  output,    width = 1,                .valid
		.rp_data                 (matrix_unit_0_avmm_a_csr_agent_rp_data),                       //  output,  width = 132,                .data
		.rp_startofpacket        (matrix_unit_0_avmm_a_csr_agent_rp_startofpacket),              //  output,    width = 1,                .startofpacket
		.cp_ready                (matrix_unit_0_avmm_a_csr_burst_adapter_source0_ready),         //  output,    width = 1,              cp.ready
		.cp_valid                (matrix_unit_0_avmm_a_csr_burst_adapter_source0_valid),         //   input,    width = 1,                .valid
		.cp_data                 (matrix_unit_0_avmm_a_csr_burst_adapter_source0_data),          //   input,  width = 132,                .data
		.cp_startofpacket        (matrix_unit_0_avmm_a_csr_burst_adapter_source0_startofpacket), //   input,    width = 1,                .startofpacket
		.cp_endofpacket          (matrix_unit_0_avmm_a_csr_burst_adapter_source0_endofpacket),   //   input,    width = 1,                .endofpacket
		.cp_channel              (matrix_unit_0_avmm_a_csr_burst_adapter_source0_channel),       //   input,    width = 6,                .channel
		.rf_sink_ready           (matrix_unit_0_avmm_a_csr_agent_rsp_fifo_out_ready),            //  output,    width = 1,         rf_sink.ready
		.rf_sink_valid           (matrix_unit_0_avmm_a_csr_agent_rsp_fifo_out_valid),            //   input,    width = 1,                .valid
		.rf_sink_startofpacket   (matrix_unit_0_avmm_a_csr_agent_rsp_fifo_out_startofpacket),    //   input,    width = 1,                .startofpacket
		.rf_sink_endofpacket     (matrix_unit_0_avmm_a_csr_agent_rsp_fifo_out_endofpacket),      //   input,    width = 1,                .endofpacket
		.rf_sink_data            (matrix_unit_0_avmm_a_csr_agent_rsp_fifo_out_data),             //   input,  width = 133,                .data
		.rf_source_ready         (matrix_unit_0_avmm_a_csr_agent_rf_source_ready),               //   input,    width = 1,       rf_source.ready
		.rf_source_valid         (matrix_unit_0_avmm_a_csr_agent_rf_source_valid),               //  output,    width = 1,                .valid
		.rf_source_startofpacket (matrix_unit_0_avmm_a_csr_agent_rf_source_startofpacket),       //  output,    width = 1,                .startofpacket
		.rf_source_endofpacket   (matrix_unit_0_avmm_a_csr_agent_rf_source_endofpacket),         //  output,    width = 1,                .endofpacket
		.rf_source_data          (matrix_unit_0_avmm_a_csr_agent_rf_source_data),                //  output,  width = 133,                .data
		.rdata_fifo_sink_ready   (matrix_unit_0_avmm_a_csr_agent_rdata_fifo_out_ready),          //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (matrix_unit_0_avmm_a_csr_agent_rdata_fifo_out_valid),          //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (matrix_unit_0_avmm_a_csr_agent_rdata_fifo_out_data),           //   input,   width = 34,                .data
		.rdata_fifo_src_ready    (matrix_unit_0_avmm_a_csr_agent_rdata_fifo_src_ready),          //   input,    width = 1,  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (matrix_unit_0_avmm_a_csr_agent_rdata_fifo_src_valid),          //  output,    width = 1,                .valid
		.rdata_fifo_src_data     (matrix_unit_0_avmm_a_csr_agent_rdata_fifo_src_data),           //  output,   width = 34,                .data
		.m0_response             (2'b00),                                                        // (terminated),                               
		.m0_writeresponsevalid   (1'b0),                                                         // (terminated),                               
		.rdata_fifo_sink_error   (1'b0)                                                          // (terminated),                               
	);
	...
	mu_afu_system_altera_avalon_sc_fifo_191_e5eqkcq #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (0)
	) matrix_unit_0_avmm_a_csr_agent_rsp_fifo (
		.clk               (matmul_afu_matmul_clock_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset             (matrix_unit_0_reset_n_reset_bridge_in_reset_reset),         //   input,    width = 1, clk_reset.reset
		.in_data           (matrix_unit_0_avmm_a_csr_agent_rf_source_data),             //   input,  width = 133,        in.data
		.in_valid          (matrix_unit_0_avmm_a_csr_agent_rf_source_valid),            //   input,    width = 1,          .valid
		.in_ready          (matrix_unit_0_avmm_a_csr_agent_rf_source_ready),            //  output,    width = 1,          .ready
		.in_startofpacket  (matrix_unit_0_avmm_a_csr_agent_rf_source_startofpacket),    //   input,    width = 1,          .startofpacket
		.in_endofpacket    (matrix_unit_0_avmm_a_csr_agent_rf_source_endofpacket),      //   input,    width = 1,          .endofpacket
		.out_data          (matrix_unit_0_avmm_a_csr_agent_rsp_fifo_out_data),          //  output,  width = 133,       out.data
		.out_valid         (matrix_unit_0_avmm_a_csr_agent_rsp_fifo_out_valid),         //  output,    width = 1,          .valid
		.out_ready         (matrix_unit_0_avmm_a_csr_agent_rsp_fifo_out_ready),         //   input,    width = 1,          .ready
		.out_startofpacket (matrix_unit_0_avmm_a_csr_agent_rsp_fifo_out_startofpacket), //  output,    width = 1,          .startofpacket
		.out_endofpacket   (matrix_unit_0_avmm_a_csr_agent_rsp_fifo_out_endofpacket),   //  output,    width = 1,          .endofpacket
		.csr_address       (2'b00),                                                     // (terminated),                         
		.csr_read          (1'b0),                                                      // (terminated),                         
		.csr_write         (1'b0),                                                      // (terminated),                         
		.csr_readdata      (),                                                          // (terminated),                         
	...
	mu_afu_system_altera_avalon_sc_fifo_191_e5eqkcq #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (0)
	) matrix_unit_0_avmm_a_csr_agent_rdata_fifo (
		.clk               (matmul_afu_matmul_clock_out_clk_clk),                 //   input,   width = 1,       clk.clk
		.reset             (matrix_unit_0_reset_n_reset_bridge_in_reset_reset),   //   input,   width = 1, clk_reset.reset
		.in_data           (matrix_unit_0_avmm_a_csr_agent_rdata_fifo_src_data),  //   input,  width = 34,        in.data
		.in_valid          (matrix_unit_0_avmm_a_csr_agent_rdata_fifo_src_valid), //   input,   width = 1,          .valid
		.in_ready          (matrix_unit_0_avmm_a_csr_agent_rdata_fifo_src_ready), //  output,   width = 1,          .ready
		.out_data          (matrix_unit_0_avmm_a_csr_agent_rdata_fifo_out_data),  //  output,  width = 34,       out.data
		.out_valid         (matrix_unit_0_avmm_a_csr_agent_rdata_fifo_out_valid), //  output,   width = 1,          .valid
		.out_ready         (matrix_unit_0_avmm_a_csr_agent_rdata_fifo_out_ready), //   input,   width = 1,          .ready
		.csr_address       (2'b00),                                               // (terminated),                        
		.csr_read          (1'b0),                                                // (terminated),                        
		.csr_write         (1'b0),                                                // (terminated),                        
		.csr_readdata      (),                                                    // (terminated),                        
	...
	mu_afu_system_altera_merlin_router_191_fl5yday router (
	...
	mu_afu_system_altera_merlin_router_191_u7ysgsy router_004 (
		.sink_ready         (matrix_unit_0_avmm_a_csr_agent_rp_ready),           //  output,    width = 1,      sink.ready
		.sink_valid         (matrix_unit_0_avmm_a_csr_agent_rp_valid),           //   input,    width = 1,          .valid
		.sink_data          (matrix_unit_0_avmm_a_csr_agent_rp_data),            //   input,  width = 132,          .data
		.sink_startofpacket (matrix_unit_0_avmm_a_csr_agent_rp_startofpacket),   //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (matrix_unit_0_avmm_a_csr_agent_rp_endofpacket),     //   input,    width = 1,          .endofpacket
		.clk                (matmul_afu_matmul_clock_out_clk_clk),               //   input,    width = 1,       clk.clk
		.reset              (matrix_unit_0_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	mu_afu_system_altera_merlin_traffic_limiter_191_kcba44q #(
		...
		.cmd_src_channel        (matmul_afu_csr_bridge_master_limiter_cmd_src_channel),                      //  output,    width = 6,          .channel
		...
		.rsp_src_channel        (matmul_afu_csr_bridge_master_limiter_rsp_src_channel),                      //  output,    width = 6,          .channel
		...
		.cmd_src_valid          (matmul_afu_csr_bridge_master_limiter_cmd_valid_data)                        //  output,    width = 6, cmd_valid.data
	);
	...
	mu_afu_system_altera_merlin_burst_adapter_191_7phgwai #(
		...
		.SYNC_RESET                (0)
	) matrix_unit_0_avmm_a_csr_burst_adapter (
		.clk                   (matmul_afu_matmul_clock_out_clk_clk),                          //   input,    width = 1,       cr0.clk
		.reset                 (matrix_unit_0_reset_n_reset_bridge_in_reset_reset),            //   input,    width = 1, cr0_reset.reset
		.sink0_valid           (matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_valid),         //   input,    width = 1,     sink0.valid
		.sink0_data            (matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_data),          //   input,  width = 132,          .data
		.sink0_channel         (matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_channel),       //   input,    width = 6,          .channel
		.sink0_startofpacket   (matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink0_endofpacket     (matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink0_ready           (matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_ready),         //  output,    width = 1,          .ready
		.source0_valid         (matrix_unit_0_avmm_a_csr_burst_adapter_source0_valid),         //  output,    width = 1,   source0.valid
		.source0_data          (matrix_unit_0_avmm_a_csr_burst_adapter_source0_data),          //  output,  width = 132,          .data
		.source0_channel       (matrix_unit_0_avmm_a_csr_burst_adapter_source0_channel),       //  output,    width = 6,          .channel
		.source0_startofpacket (matrix_unit_0_avmm_a_csr_burst_adapter_source0_startofpacket), //  output,    width = 1,          .startofpacket
		.source0_endofpacket   (matrix_unit_0_avmm_a_csr_burst_adapter_source0_endofpacket),   //  output,    width = 1,          .endofpacket
		.source0_ready         (matrix_unit_0_avmm_a_csr_burst_adapter_source0_ready)          //   input,    width = 1,          .ready
	);
	...
	mu_afu_system_altera_merlin_demultiplexer_191_xl3kg5y cmd_demux (
		...
		.sink_channel       (matmul_afu_csr_bridge_master_limiter_cmd_src_channel),                      //   input,    width = 6,           .channel
		...
		.sink_valid         (matmul_afu_csr_bridge_master_limiter_cmd_valid_data),                       //   input,    width = 6, sink_valid.data
	...
	mu_afu_system_altera_merlin_demultiplexer_191_qi6d64a rsp_demux_003 (
		.clk                (matmul_afu_matmul_clock_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset              (matrix_unit_0_reset_n_reset_bridge_in_reset_reset),            //   input,    width = 1, clk_reset.reset
		.sink_ready         (matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_channel),       //   input,    width = 6,          .channel
		.sink_data          (matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_data),          //   input,  width = 168,          .data
		.sink_startofpacket (matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink_valid         (matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_valid),         //   input,    width = 1,          .valid
	...
	mu_afu_system_altera_merlin_width_adapter_191_znesz2a #(
		...
		.SYNC_RESET                    (0)
	) matrix_unit_0_avmm_a_csr_rsp_width_adapter (
		.clk                  (matmul_afu_matmul_clock_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset                (matrix_unit_0_reset_n_reset_bridge_in_reset_reset),            //   input,    width = 1, clk_reset.reset
		...
		.out_endofpacket      (matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_data),          //  output,  width = 168,          .data
		.out_channel          (matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_channel),       //  output,    width = 6,          .channel
		.out_valid            (matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (matrix_unit_0_avmm_a_csr_rsp_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
	...
	mu_afu_system_altera_merlin_width_adapter_191_34t32ka #(
		...
		.ENABLE_ADDRESS_ALIGNMENT      (0),
		.SYNC_RESET                    (0)
	) matrix_unit_0_avmm_a_csr_cmd_width_adapter (
		.clk                  (matmul_afu_matmul_clock_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset                (matrix_unit_0_reset_n_reset_bridge_in_reset_reset),            //   input,    width = 1, clk_reset.reset
		...
		.out_endofpacket      (matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_data),          //  output,  width = 132,          .data
		.out_channel          (matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_channel),       //  output,    width = 6,          .channel
		.out_valid            (matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (matrix_unit_0_avmm_a_csr_cmd_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                                        // (terminated),                         
	);
	...
	mu_afu_system_altera_avalon_st_handshake_clock_crosser_191_zeqaxly #(
		...
		.out_reset         (matrix_unit_0_reset_n_reset_bridge_in_reset_reset),                         //   input,    width = 1, out_clk_reset.reset
	...
	mu_afu_system_altera_avalon_st_handshake_clock_crosser_191_zeqaxly #(
		...
		.in_reset          (matrix_unit_0_reset_n_reset_bridge_in_reset_reset),                         //   input,    width = 1,  in_clk_reset.reset
