// matmul_afu_system_fixed_altera_mm_interconnect_191_6n6nery.v
...
`timescale 1 ps / 1 ps
module matmul_afu_system_fixed_altera_mm_interconnect_191_6n6nery (
	...
	wire          matmul_afu_start_matmul_s1_agent_rdata_fifo_src_valid;                           // matmul_afu_start_matmul_s1_agent:rdata_fifo_src_valid -> matmul_afu_start_matmul_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] matmul_afu_start_matmul_s1_agent_rdata_fifo_src_data;                            // matmul_afu_start_matmul_s1_agent:rdata_fifo_src_data -> matmul_afu_start_matmul_s1_agent:rdata_fifo_sink_data
	wire          matmul_afu_start_matmul_s1_agent_rdata_fifo_src_ready;                           // matmul_afu_start_matmul_s1_agent:rdata_fifo_sink_ready -> matmul_afu_start_matmul_s1_agent:rdata_fifo_src_ready
	...
	wire          matmul_afu_matmul_ready_s1_agent_rdata_fifo_src_valid;                           // matmul_afu_matmul_ready_s1_agent:rdata_fifo_src_valid -> matmul_afu_matmul_ready_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] matmul_afu_matmul_ready_s1_agent_rdata_fifo_src_data;                            // matmul_afu_matmul_ready_s1_agent:rdata_fifo_src_data -> matmul_afu_matmul_ready_s1_agent:rdata_fifo_sink_data
	wire          matmul_afu_matmul_ready_s1_agent_rdata_fifo_src_ready;                           // matmul_afu_matmul_ready_s1_agent:rdata_fifo_sink_ready -> matmul_afu_matmul_ready_s1_agent:rdata_fifo_src_ready
	...
	wire  [167:0] cmd_demux_src5_data;                                                             // cmd_demux:src5_data -> cmd_mux_005:sink0_data
	...
	wire  [167:0] rsp_demux_005_src0_data;                                                         // rsp_demux_005:src0_data -> rsp_mux:sink5_data
	...
	matmul_afu_system_fixed_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rdata_fifo_sink_ready   (matmul_afu_start_matmul_s1_agent_rdata_fifo_src_ready),          //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (matmul_afu_start_matmul_s1_agent_rdata_fifo_src_valid),          //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (matmul_afu_start_matmul_s1_agent_rdata_fifo_src_data),           //   input,   width = 34,                .data
	...
	matmul_afu_system_fixed_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rdata_fifo_sink_ready   (matmul_afu_matmul_ready_s1_agent_rdata_fifo_src_ready),          //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (matmul_afu_matmul_ready_s1_agent_rdata_fifo_src_valid),          //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (matmul_afu_matmul_ready_s1_agent_rdata_fifo_src_data),           //   input,   width = 34,                .data
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_c6lilqy cmd_mux_005 (
		...
		.sink0_data          (cmd_demux_src5_data),                                       //   input,  width = 168,          .data
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_6vqksxa rsp_mux (
		...
		.sink5_data          (rsp_demux_005_src0_data),                                   //   input,  width = 168,          .data
