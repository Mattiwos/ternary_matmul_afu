// matmul_afu_system_fixed_altera_mm_interconnect_191_aunvufq.v
...
`timescale 1 ps / 1 ps
module matmul_afu_system_fixed_altera_mm_interconnect_191_aunvufq (
	...
	wire    [5:0] cmd_mux_003_src_channel;                                                         // cmd_mux_003:src_channel -> msgdma_bbb_csr_agent:cp_channel
	...
	wire    [5:0] matmul_afu_start_matmul_s1_burst_adapter_source0_channel;                        // matmul_afu_start_matmul_s1_burst_adapter:source0_channel -> matmul_afu_start_matmul_s1_agent:cp_channel
	...
	wire    [5:0] matmul_afu_matmul_ready_s1_burst_adapter_source0_channel;                        // matmul_afu_matmul_ready_s1_burst_adapter:source0_channel -> matmul_afu_matmul_ready_s1_agent:cp_channel
	...
	wire    [5:0] router_005_src_channel;                                                          // router_005:src_channel -> matmul_afu_start_matmul_s1_rsp_width_adapter:in_channel
	...
	wire    [5:0] matmul_afu_start_matmul_s1_rsp_width_adapter_src_channel;                        // matmul_afu_start_matmul_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire    [5:0] router_006_src_channel;                                                          // router_006:src_channel -> matmul_afu_matmul_ready_s1_rsp_width_adapter:in_channel
	...
	wire    [5:0] matmul_afu_matmul_ready_s1_rsp_width_adapter_src_channel;                        // matmul_afu_matmul_ready_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	...
	wire    [5:0] cmd_mux_004_src_channel;                                                         // cmd_mux_004:src_channel -> matmul_afu_start_matmul_s1_cmd_width_adapter:in_channel
	...
	wire    [5:0] matmul_afu_start_matmul_s1_cmd_width_adapter_src_channel;                        // matmul_afu_start_matmul_s1_cmd_width_adapter:out_channel -> matmul_afu_start_matmul_s1_burst_adapter:sink0_channel
	...
	wire    [5:0] cmd_mux_005_src_channel;                                                         // cmd_mux_005:src_channel -> matmul_afu_matmul_ready_s1_cmd_width_adapter:in_channel
	...
	wire    [5:0] matmul_afu_matmul_ready_s1_cmd_width_adapter_src_channel;                        // matmul_afu_matmul_ready_s1_cmd_width_adapter:out_channel -> matmul_afu_matmul_ready_s1_burst_adapter:sink0_channel
	...
	wire  [167:0] rsp_demux_004_src0_data;                                                         // rsp_demux_004:src0_data -> crosser_002:in_data
	...
	wire  [167:0] crosser_002_out_data;                                                            // crosser_002:out_data -> rsp_mux:sink4_data
	...
	matmul_afu_system_fixed_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.cp_channel              (matmul_afu_start_matmul_s1_burst_adapter_source0_channel),       //   input,    width = 6,                .channel
	...
	matmul_afu_system_fixed_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.cp_channel              (matmul_afu_matmul_ready_s1_burst_adapter_source0_channel),       //   input,    width = 6,                .channel
	...
	matmul_afu_system_fixed_altera_merlin_router_191_lh25dpa router (
	...
	matmul_afu_system_fixed_altera_merlin_router_191_nq2z62q router_001 (
	...
	matmul_afu_system_fixed_altera_merlin_router_191_nq2z62q router_002 (
	...
	matmul_afu_system_fixed_altera_merlin_router_191_nq2z62q router_003 (
	...
	matmul_afu_system_fixed_altera_merlin_router_191_nq2z62q router_004 (
	...
	matmul_afu_system_fixed_altera_merlin_router_191_u7ysgsy router_005 (
	...
	matmul_afu_system_fixed_altera_merlin_router_191_u7ysgsy router_006 (
	...
	matmul_afu_system_fixed_altera_merlin_burst_adapter_191_7phgwai #(
		...
		.sink0_channel         (matmul_afu_start_matmul_s1_cmd_width_adapter_src_channel),       //   input,    width = 6,          .channel
		...
		.source0_channel       (matmul_afu_start_matmul_s1_burst_adapter_source0_channel),       //  output,    width = 6,          .channel
	...
	matmul_afu_system_fixed_altera_merlin_burst_adapter_191_7phgwai #(
		...
		.sink0_channel         (matmul_afu_matmul_ready_s1_cmd_width_adapter_src_channel),       //   input,    width = 6,          .channel
		...
		.source0_channel       (matmul_afu_matmul_ready_s1_burst_adapter_source0_channel),       //  output,    width = 6,          .channel
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_xl3kg5y cmd_demux (
		.clk                (matmul_afu_dma_clock_out_clk_clk),                                          //   input,    width = 1,        clk.clk
		.reset              (matmul_afu_csr_bridge_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_c6lilqy cmd_mux (
		.clk                 (matmul_afu_dma_clock_out_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset               (matmul_afu_csr_bridge_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_c6lilqy cmd_mux_001 (
		.clk                 (matmul_afu_dma_clock_out_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset               (matmul_afu_csr_bridge_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_c6lilqy cmd_mux_002 (
		.clk                 (matmul_afu_dma_clock_out_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset               (matmul_afu_csr_bridge_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_c6lilqy cmd_mux_003 (
		.clk                 (matmul_afu_dma_clock_out_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset               (matmul_afu_csr_bridge_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_c6lilqy cmd_mux_004 (
		.clk                 (matmul_afu_matmul_clock_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset               (matmul_afu_start_matmul_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_c6lilqy cmd_mux_005 (
		.clk                 (matmul_afu_matmul_clock_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset               (matmul_afu_start_matmul_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_qi6d64a rsp_demux (
		.clk                (matmul_afu_dma_clock_out_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset              (matmul_afu_csr_bridge_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_qi6d64a rsp_demux_001 (
		.clk                (matmul_afu_dma_clock_out_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset              (matmul_afu_csr_bridge_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_qi6d64a rsp_demux_002 (
		.clk                (matmul_afu_dma_clock_out_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset              (matmul_afu_csr_bridge_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_qi6d64a rsp_demux_003 (
		.clk                (matmul_afu_dma_clock_out_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset              (matmul_afu_csr_bridge_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_qi6d64a rsp_demux_004 (
		.clk                (matmul_afu_matmul_clock_out_clk_clk),                            //   input,    width = 1,       clk.clk
		.reset              (matmul_afu_start_matmul_reset_reset_bridge_in_reset_reset),      //   input,    width = 1, clk_reset.reset
		.sink_ready         (matmul_afu_start_matmul_s1_rsp_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (matmul_afu_start_matmul_s1_rsp_width_adapter_src_channel),       //   input,    width = 6,          .channel
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_qi6d64a rsp_demux_005 (
		.clk                (matmul_afu_matmul_clock_out_clk_clk),                            //   input,    width = 1,       clk.clk
		.reset              (matmul_afu_start_matmul_reset_reset_bridge_in_reset_reset),      //   input,    width = 1, clk_reset.reset
		.sink_ready         (matmul_afu_matmul_ready_s1_rsp_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (matmul_afu_matmul_ready_s1_rsp_width_adapter_src_channel),       //   input,    width = 6,          .channel
	...
	matmul_afu_system_fixed_altera_merlin_multiplexer_191_6vqksxa rsp_mux (
		.clk                 (matmul_afu_dma_clock_out_clk_clk),                                          //   input,    width = 1,       clk.clk
		.reset               (matmul_afu_csr_bridge_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink4_ready         (crosser_002_out_ready),                                                     //  output,    width = 1,     sink4.ready
		.sink4_valid         (crosser_002_out_valid),                                                     //   input,    width = 1,          .valid
		.sink4_channel       (crosser_002_out_channel),                                                   //   input,    width = 6,          .channel
		.sink4_data          (crosser_002_out_data),                                                      //   input,  width = 168,          .data
		.sink4_startofpacket (crosser_002_out_startofpacket),                                             //   input,    width = 1,          .startofpacket
		.sink4_endofpacket   (crosser_002_out_endofpacket),                                               //   input,    width = 1,          .endofpacket
	...
	matmul_afu_system_fixed_altera_merlin_width_adapter_191_znesz2a #(
		...
		.out_channel          (matmul_afu_start_matmul_s1_rsp_width_adapter_src_channel),       //  output,    width = 6,          .channel
	...
	matmul_afu_system_fixed_altera_merlin_width_adapter_191_znesz2a #(
		...
		.out_channel          (matmul_afu_matmul_ready_s1_rsp_width_adapter_src_channel),       //  output,    width = 6,          .channel
	...
	matmul_afu_system_fixed_altera_merlin_width_adapter_191_34t32ka #(
		...
		.out_channel          (matmul_afu_start_matmul_s1_cmd_width_adapter_src_channel),       //  output,    width = 6,          .channel
	...
	matmul_afu_system_fixed_altera_merlin_width_adapter_191_34t32ka #(
		...
		.out_channel          (matmul_afu_matmul_ready_s1_cmd_width_adapter_src_channel),       //  output,    width = 6,          .channel
	...
	matmul_afu_system_fixed_altera_avalon_st_handshake_clock_crosser_191_zeqaxly #(
		.DATA_WIDTH          (168),
		.BITS_PER_SYMBOL     (168),
		.USE_PACKETS         (1),
		.USE_CHANNEL         (1),
