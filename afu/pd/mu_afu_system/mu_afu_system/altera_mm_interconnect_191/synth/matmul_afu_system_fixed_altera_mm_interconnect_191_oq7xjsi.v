// matmul_afu_system_fixed_altera_mm_interconnect_191_oq7xjsi.v
...
`timescale 1 ps / 1 ps
module matmul_afu_system_fixed_altera_mm_interconnect_191_oq7xjsi (
	...
	wire          rsp_mux_src_valid;                                                                    // rsp_mux:src_valid -> matmul_afu_matmul_ddr4a_bridge_m0_agent:rp_valid
	wire  [672:0] rsp_mux_src_data;                                                                     // rsp_mux:src_data -> matmul_afu_matmul_ddr4a_bridge_m0_agent:rp_data
	wire          rsp_mux_src_ready;                                                                    // matmul_afu_matmul_ddr4a_bridge_m0_agent:rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                                  // rsp_mux:src_channel -> matmul_afu_matmul_ddr4a_bridge_m0_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                            // rsp_mux:src_startofpacket -> matmul_afu_matmul_ddr4a_bridge_m0_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                              // rsp_mux:src_endofpacket -> matmul_afu_matmul_ddr4a_bridge_m0_agent:rp_endofpacket
	...
	wire  [672:0] matmul_afu_matmul_ddr4a_bridge_m0_agent_cp_data;                                      // matmul_afu_matmul_ddr4a_bridge_m0_agent:cp_data -> router:sink_data
	...
	wire  [672:0] router_src_data;                                                                      // router:src_data -> cmd_demux:sink_data
	...
	matmul_afu_system_fixed_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.cp_data               (matmul_afu_matmul_ddr4a_bridge_m0_agent_cp_data),                                      //  output,  width = 673,          .data
		...
		.rp_data               (rsp_mux_src_data),                                                                     //   input,  width = 673,          .data
	...
	matmul_afu_system_fixed_altera_merlin_router_191_bh3mw6y router (
		...
		.sink_data          (matmul_afu_matmul_ddr4a_bridge_m0_agent_cp_data),                  //   input,  width = 673,          .data
		...
		.src_data           (router_src_data),                                                  //  output,  width = 673,          .data
	...
	matmul_afu_system_fixed_altera_merlin_demultiplexer_191_kuuxkea cmd_demux (
		...
		.sink_data          (router_src_data),                                                  //   input,  width = 673,          .data
