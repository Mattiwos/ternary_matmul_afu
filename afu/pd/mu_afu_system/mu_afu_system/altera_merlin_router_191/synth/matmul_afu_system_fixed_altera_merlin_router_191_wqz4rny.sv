...
module matmul_afu_system_fixed_altera_merlin_router_191_wqz4rny_default_decode
  #(
...
module matmul_afu_system_fixed_altera_merlin_router_191_wqz4rny
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD6 = log2ceil(64'h800 - 64'h600); 
    // -------------------------------------------------------
    ...
    matmul_afu_system_fixed_altera_merlin_router_191_wqz4rny_default_decode the_default_decode(
    ...
    // ( 0x500 .. 0x510 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 11'h500  && read_transaction  ) begin
