...
module matmul_afu_system_fixed_altera_merlin_router_191_ip4pfjq_default_decode
  #(
  ...
  (output [156 - 154 : 0] default_destination_id,
...
module matmul_afu_system_fixed_altera_merlin_router_191_ip4pfjq
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    // -------------------------------------------------------
    localparam PKT_ADDR_H = 119;
    localparam PKT_ADDR_L = 72;
    localparam PKT_DEST_ID_H = 156;
    ...
    localparam PKT_TRANS_WRITE = 122;
    localparam PKT_TRANS_READ  = 123;
    ...
    localparam PAD6 = log2ceil(64'h1200 - 64'h1000); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h1200;
    ...
    matmul_afu_system_fixed_altera_merlin_router_191_ip4pfjq_default_decode the_default_decode(
