...
module matmul_afu_system_fixed_altera_merlin_router_191_dgn5kyy_default_decode
  #(
...
module matmul_afu_system_fixed_altera_merlin_router_191_dgn5kyy
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    matmul_afu_system_fixed_altera_merlin_router_191_dgn5kyy_default_decode the_default_decode(
    ...
    // ( 0x500 .. 0x510 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 13'h500  && read_transaction  ) begin
