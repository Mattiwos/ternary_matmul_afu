	component matmul_afu_matmul_ddr4a_bridge is
		generic (
		...
		port (
			...
			s0_byteenable    : in  std_logic_vector(0 downto 0)                  := (others => 'X'); -- byteenable
	...
	end component matmul_afu_matmul_ddr4a_bridge;

	u0 : component matmul_afu_matmul_ddr4a_bridge
		generic map (
